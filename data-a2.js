const dataA2 = [
  // ==========================================
  // --- TỪ VỰNG BÀI 1 & 2 - CẤP ĐỘ TOCFL A2 (BẢN NÂNG CẤP CHI TIẾT) ---
  // ==========================================
  {
    word: "走", pinyin: "zǒu", hanViet: "Tẩu",
    image: "",
    radical: "走 (Bộ Tẩu 走 - Đi, chạy)<br>💡 Mẹo nhớ: Chữ 走 nhìn giống hình ảnh một người đang sải bước chạy, vung tay vung chân (phần trên giống chữ 土 - đất) đạp mạnh xuống mặt đường (phần dưới giống bàn chân).",
    explanation: "Động từ: Đi, bước đi, rời đi.",
    compounds: [
      { tc: "走路", py: "zǒulù", vn: "đi bộ" },
      { tc: "走開", py: "zǒukāi", vn: "tránh ra" }
    ],
    examples: [
      { tc: "我們走吧，時間不早了！", py: "Wǒmen zǒu ba, shíjiān bù zǎo le!", vn: "Chúng ta đi thôi, muộn rồi!" },
      { tc: "從這裡往前走大約五分鐘就到了。", py: "Cóng zhèlǐ wǎng qián zǒu dàyuē wǔ fēnzhōng jiù dào le.", vn: "Từ đây đi thẳng về phía trước khoảng 5 phút là tới." }
    ],
    idiom: "說走就走 (Shuō zǒu jiù zǒu) - Nói đi là đi (Hành động quyết đoán, thường dùng cho du lịch).<br>🔸 Ví dụ: 考完試後，我們來一趟說走就走的旅行吧！ (Kǎo wán shì hòu, wǒmen lái yí tàng shuō zǒu jiù zǒu de lǚxíng ba! - Thi xong, chúng ta hãy làm một chuyến du lịch nói đi là đi nhé!)", 
    level: "TOCFL A2"
  },
  {
    word: "路人", pinyin: "lùrén", hanViet: "Lộ nhân",
    image: "",
    radical: "路 (Bộ Túc 足 - Bàn chân) + 人 (Bộ Nhân 人 - Người)<br>💡 Mẹo nhớ: Chữ 路 (Đường) gồm bộ Túc (chân) và chữ Các 各 (mỗi, từng). Ý nghĩa là: Từng bước chân của mọi người dẫm mãi mà tạo thành con đường.",
    explanation: "Danh từ: Người qua đường.",
    compounds: [
      { tc: "馬路", py: "mǎlù", vn: "đường lớn" },
      { tc: "問路", py: "wènlù", vn: "hỏi đường" }
    ],
    examples: [
      { tc: "我剛才向一個路人問路。", py: "Wǒ gāngcái xiàng yí ge lùrén wèn lù.", vn: "Tôi vừa hỏi đường một người qua đường." },
      { tc: "這個路口有很多路人，開車要小心。", py: "Zhège lùkǒu yǒu hěn duō lùrén, kāichē yào xiǎoxīn.", vn: "Ngã tư này có rất nhiều người qua đường, lái xe phải cẩn thận." }
    ],
    idiom: "路人甲 (Lùrén jiǎ) - Người qua đường vô danh / Kẻ mờ nhạt (Từ lóng).<br>🔸 Ví dụ: 在這部電影裡，我感覺自己只是一個路人甲。(Zài zhè bù diànyǐng lǐ, wǒ gǎnjué zìjǐ zhǐ shì yí ge lùrén jiǎ. - Trong bộ phim này, tôi cảm thấy mình chỉ như một kẻ vô danh.)", 
    level: "TOCFL A2"
  },
  {
    word: "幫忙", pinyin: "bāngmáng", hanViet: "Bang mang",
    image: "",
    radical: "幫 (Bộ Cân 巾 - Khăn vải) + 忙 (Bộ Tâm 心 - Trái tim)<br>💡 Mẹo nhớ: Chữ 忙 (Bận rộn) gồm trái tim (心) đi liền với chữ Vong (亡 - Mất). Khi quá bận rộn, trái tim dường như đánh mất sự thảnh thơi.",
    explanation: "Động từ ly hợp: Giúp đỡ, phụ một tay.",
    compounds: [
      { tc: "幫手", py: "bāngshǒu", vn: "người phụ giúp" }
    ],
    examples: [
      { tc: "你可以幫我一個忙嗎？", py: "Nǐ kěyǐ bāng wǒ yí ge máng ma?", vn: "Bạn có thể giúp tôi một việc được không?" },
      { tc: "這個問題太難了，我們需要老師的幫忙。", py: "Zhège wèntí tài nán le, wǒmen xūyào lǎoshī de bāngmáng.", vn: "Vấn đề này khó quá, chúng ta cần sự giúp đỡ của giáo viên." }
    ],
    idiom: "越幫越忙 (Yuè bāng yuè máng) - Càng giúp càng rối / Giúp thành phá.<br>🔸 Ví dụ: 你別弄了，簡直是越幫越忙！ (Nǐ bié nòng le, jiǎnzhí shì yuè bāng yuè máng! - Cậu đừng động vào nữa, đúng là càng giúp càng làm rối thêm!)", 
    level: "TOCFL A2"
  },
  {
    word: "迷路", pinyin: "mílù", hanViet: "Mê lộ",
    image: "",
    radical: "迷 (Bộ Xước 辶 - Bước đi) + 路 (Bộ Túc 足 - Bàn chân)<br>💡 Mẹo nhớ: Chữ 迷 (Mê/Lạc) gồm bộ Xước (辶 - đi) và chữ Mễ (米 - gạo). Có thể tưởng tượng: Đi đường mà rải gạo để đánh dấu nhưng bị chim ăn mất nên cuối cùng bị lạc.",
    explanation: "Động từ ly hợp: Lạc đường.",
    compounds: [
      { tc: "迷宮", py: "mígōng", vn: "mê cung" }
    ],
    examples: [
      { tc: "因為沒帶手機，他在台北車站迷路了。", py: "Yīnwèi méi dài shǒujī, tā zài Táiběi chēzhàn mílù le.", vn: "Vì không mang điện thoại, anh ấy đã lạc đường ở Ga Đài Bắc." },
      { tc: "如果你迷路了，可以去便利商店問店員。", py: "Rúguǒ nǐ mílù le, kěyǐ qù biànlì shāngdiàn wèn diànyuán.", vn: "Nếu bạn lạc đường, có thể vào cửa hàng tiện lợi hỏi nhân viên." }
    ],
    idiom: "路痴 (Lùchī) - Kẻ mù đường (Người không giỏi xác định phương hướng).<br>🔸 Ví dụ: 我是一個大路痴，沒有導航就不敢出門。(Wǒ shì yí ge dà lùchī, méiyǒu dǎoháng jiù bù gǎn chūmén. - Tôi là một đứa mù đường nặng, không có bản đồ thì không dám ra khỏi nhà.)", 
    level: "TOCFL A2"
  },
  {
    word: "下", pinyin: "xià", hanViet: "Hạ",
    image: "",
    radical: "下 (Bộ Nhất 一 - Số một)<br>💡 Mẹo nhớ: Chữ 下 là chữ chỉ sự, với một nét ngang dài (一) làm đường chuẩn, và một nét gạch chéo nằm bên dưới để chỉ ý nghĩa 'ở phía dưới'.",
    explanation: "Đại từ chỉ định / Động từ: Dưới, tiếp theo, xuống.",
    compounds: [
      { tc: "樓下", py: "lóuxià", vn: "dưới lầu" },
      { tc: "下車", py: "xiàchē", vn: "xuống xe" }
    ],
    examples: [
      { tc: "我們下個月打算去日本玩。", py: "Wǒmen xià ge yuè dǎsuàn qù Rìběn wán.", vn: "Tháng sau chúng tôi dự định đi Nhật Bản chơi." },
      { tc: "請大家準備好，我們下一站要下車了。", py: "Qǐng dàjiā zhǔnbèi hǎo, wǒmen xià yí zhàn yào xiàchē le.", vn: "Xin mọi người chuẩn bị sẵn sàng, trạm tiếp theo chúng ta sẽ xuống xe rồi." }
    ],
    idiom: "下不為例 (Xià bù wéi lì) - Lần sau không được thế này nữa / Chỉ châm chước lần này.<br>🔸 Ví dụ: 這次就原諒你，但是下不為例喔！(Zhè cì jiù yuánliàng nǐ, dànshì xià bù wéi lì ō! - Lần này bỏ qua cho cậu, nhưng lần sau không được thế nữa đâu nhé!)", 
    level: "TOCFL A2"
  },
  {
    word: "路口", pinyin: "lùkǒu", hanViet: "Lộ khẩu",
    image: "",
    radical: "路 (Bộ Túc 足 - Bàn chân) + 口 (Bộ Khẩu 口 - Cái miệng/Cửa)<br>💡 Mẹo nhớ: Chữ 口 (Khẩu) ngoài nghĩa là cái miệng còn mang nghĩa là cửa ngõ. Nơi đường (路) giao nhau tạo thành cửa ngõ đi lại chính là ngã rẽ.",
    explanation: "Danh từ: Giao lộ, ngã rẽ.",
    compounds: [
      { tc: "十字路口", py: "shízì lùkǒu", vn: "ngã tư" }
    ],
    examples: [
      { tc: "在下一個路口請右轉。", py: "Zài xià yí ge lùkǒu qǐng yòu zhuǎn.", vn: "Xin hãy rẽ phải ở ngã rẽ tiếp theo." },
      { tc: "那個路口常常發生車禍，要小心。", py: "Nàge lùkǒu chángcháng fāshēng chēhuò, yào xiǎoxīn.", vn: "Ngã rẽ đó thường xuyên xảy ra tai nạn, phải cẩn thận." }
    ],
    idiom: "十字路口 (Shízì lùkǒu) - Ngã tư / Ngã rẽ cuộc đời.<br>🔸 Ví dụ: 畢業後，我覺得自己站在人生的十字路口。(Bìyè hòu, wǒ juéde zìjǐ zhàn zài rénshēng de shízì lùkǒu. - Sau khi tốt nghiệp, tôi cảm thấy mình đang đứng ở ngã tư cuộc đời.)", 
    level: "TOCFL A2"
  },
  {
    word: "段", pinyin: "duàn", hanViet: "Đoạn",
    image: "",
    radical: "段 (Bộ Thù 殳 - Binh khí dài)<br>💡 Mẹo nhớ: Bộ Thù (殳) tượng trưng cho việc cầm vũ khí/công cụ đập, chặt. Chặt một vật dài ra thành nhiều khúc nhỏ thì gọi là một Đoạn (段).",
    explanation: "Danh từ / Lượng từ: Đoạn, khúc, phần.",
    compounds: [
      { tc: "一段時間", py: "yí duàn shíjiān", vn: "một khoảng thời gian" }
    ],
    examples: [
      { tc: "這段時間我真的很忙。", py: "Zhè duàn shíjiān wǒ zhēn de hěn máng.", vn: "Khoảng thời gian này tôi thực sự rất bận." },
      { tc: "這段路正在施工，請走別條路。", py: "Zhè duàn lù zhèngzài shīgōng, qǐng zǒu bié tiáo lù.", vn: "Đoạn đường này đang thi công, vui lòng đi đường khác." }
    ],
    idiom: "告一段落 (Gào yí duànluò) - Tạm thời kết thúc / Hoàn thành một giai đoạn.<br>🔸 Ví dụ: 這個案子終於告一段落了，我們可以休息一下。(Zhège ànzi zhōngyú gào yí duànluò le, wǒmen kěyǐ xiūxí yíxià. - Dự án này cuối cùng cũng tạm thời kết thúc, chúng ta có thể nghỉ ngơi một chút.)", 
    level: "TOCFL A2"
  },
  {
    word: "過", pinyin: "guò", hanViet: "Quá",
    image: "",
    radical: "過 (Bộ Xước 辶 - Bước đi)<br>💡 Mẹo nhớ: Gồm bộ Xước (辶) chỉ sự di chuyển và chữ Qua (咼 - méo mó, xương). Di chuyển vượt qua cả những khúc xương xẩu, gian khó chính là 'vượt qua'.",
    explanation: "Động từ / Trợ từ: Băng qua, vượt qua, đã từng (trải nghiệm).",
    compounds: [
      { tc: "過去", py: "guòqù", vn: "quá khứ / qua đó" },
      { tc: "過來", py: "guòlái", vn: "qua đây" }
    ],
    examples: [
      { tc: "過馬路的時候請看紅綠燈。", py: "Guò mǎlù de shíhòu qǐng kàn hónglùdēng.", vn: "Khi qua đường vui lòng nhìn đèn giao thông." },
      { tc: "你去過台灣嗎？", py: "Nǐ qù guò Táiwān ma?", vn: "Bạn đã từng đến Đài Loan chưa?" }
    ],
    idiom: "過來人 (Guòláirén) - Người từng trải.<br>🔸 Ví dụ: 作為過來人，我建議你多學一點外語。(Zuòwéi guòláirén, wǒ jiànyì nǐ duō xué yìdiǎn wàiyǔ. - Là một người từng trải, tôi khuyên bạn nên học thêm ngoại ngữ.)", 
    level: "TOCFL A2"
  },
  {
    word: "第", pinyin: "dì", hanViet: "Đệ",
    image: "",
    radical: "第 (Bộ Trúc 竹 - Cây tre)<br>💡 Mẹo nhớ: Ngày xưa người ta viết chữ trên các thẻ tre (bộ Trúc 竹). Các thẻ tre được buộc lại và đánh số thứ tự (第) để không bị lẫn lộn.",
    ...
    examples: [
      { tc: "這是我第一次吃臭豆腐。", py: "Zhè shì wǒ dì yī cì chī chòudòufǔ.", vn: "Đây là lần đầu tiên tôi ăn đậu hũ thối." },
      { tc: "他的成績總是全班第一。", py: "Tā de chéngjī zǒngshì quán bān dì yī.", vn: "Thành tích của anh ấy luôn đứng nhất lớp." }
    ],
    idiom: "第一名 (Dì yī míng) - Hạng nhất / Đỉnh nhất (Dùng để khen ngợi).<br>🔸 Ví dụ: 這家珍珠奶茶真的是我心中的第一名！(Zhè jiā zhēnzhū nǎichá zhēn de shì wǒ xīnzhōng de dì yī míng! - Quán trà sữa trân châu này thực sự là số 1 trong lòng tôi!)", 
    level: "TOCFL A2"
  },
  {
    word: "紅綠燈", pinyin: "hónglùdēng", hanViet: "Hồng lục đăng",
    image: "",
    radical: "紅 (Bộ Mịch 糸), 綠 (Bộ Mịch 糸), 燈 (Bộ Hỏa 火)<br>💡 Mẹo nhớ: Chữ Hồng (đỏ) và Lục (xanh) đều có bộ Mịch (sợi tơ) dùng để nhuộm màu. Chữ Đăng (đèn) có bộ Hỏa (lửa) để phát sáng.",
    explanation: "Danh từ: Đèn giao thông (Đèn đỏ và xanh).",
    compounds: [
      { tc: "紅燈", py: "hóngdēng", vn: "đèn đỏ" },
      { tc: "綠燈", py: "lǜdēng", vn: "đèn xanh" }
    ],
    examples: [
      { tc: "前面有紅綠燈，請減速。", py: "Qiánmiàn yǒu hónglùdēng, qǐng jiǎnsù.", vn: "Phía trước có đèn giao thông, vui lòng giảm tốc độ." },
      { tc: "過紅綠燈後，右轉就到了。", py: "Guò hónglùdēng hòu, yòu zhuǎn jiù dào le.", vn: "Sau khi qua đèn giao thông, rẽ phải là tới." }
    ],
    idiom: "開綠燈 (Kāi lǜdēng) - Bật đèn xanh (Đồng ý, cho phép làm việc gì đó).<br>🔸 Ví dụ: 老闆已經為這個計畫開綠燈了。(Lǎobǎn yǐjīng wèi zhège jìhuà kāi lǜdēng le. - Sếp đã bật đèn xanh cho dự án này rồi.)", 
    level: "TOCFL A2"
  },
  {
    word: "告訴", pinyin: "gàosù", hanViet: "Cáo tố",
    image: "",
    radical: "告 (Bộ Khẩu 口 - Cái miệng) + 訴 (Bộ Ngôn 言 - Lời nói)<br>💡 Mẹo nhớ: Cả hai chữ đều liên quan đến việc dùng miệng (口) và lời nói (言) để truyền đạt thông tin cho người khác.",
    explanation: "Động từ: Nói cho biết, bảo.",
    compounds: [
      { tc: "報告", py: "bàogào", vn: "báo cáo" },
      { tc: "訴苦", py: "sùkǔ", vn: "than khổ" }
    ],
    examples: [
      { tc: "請你告訴我真相。", py: "Qǐng nǐ gàosù wǒ zhēnxiàng.", vn: "Xin hãy nói cho tôi biết sự thật." },
      { tc: "我告訴他明天不用來上班了。", py: "Wǒ gàosù tā míngtiān búyòng lái shàngbān le.", vn: "Tôi đã bảo anh ấy ngày mai không cần đến làm nữa." }
    ],
    idiom: "我告訴你 (Wǒ gàosù nǐ) - Để tôi nói cho bạn nghe này (Dùng khi chuẩn bị kể chuyện hoặc nhấn mạnh).<br>🔸 Ví dụ: 我告訴你，那家餐廳超級好吃！(Wǒ gàosù nǐ, nà jiā cāntīng chāojí hǎochī! - Để tôi kể bạn nghe, nhà hàng đó ngon cực kỳ!)", 
    level: "TOCFL A2"
  },
  {
    word: "提款機", pinyin: "tíkuǎnjī", hanViet: "Đề khoản cơ",
    image: "",
    radical: "提 (Bộ Thủ 手 - Tay) + 款 (Bộ Khiếm 欠 - Thiếu) + 機 (Bộ Mộc 木 - Gỗ)<br>💡 Mẹo nhớ: Dùng tay (手 - 提) để lấy khoản tiền (款) từ một cỗ máy (機).",
    explanation: "Danh từ: Máy rút tiền tự động (ATM).",
    compounds: [
      { tc: "提款卡", py: "tíkuǎnkǎ", vn: "thẻ rút tiền" }
    ],
    examples: [
      { tc: "請問這附近有提款機嗎？", py: "Qǐngwèn zhè fùjìn yǒu tíkuǎnjī ma?", vn: "Xin hỏi quanh đây có máy rút tiền không?" },
      { tc: "我的提款卡被提款機吃掉了！", py: "Wǒ de tíkuǎnkǎ bèi tíkuǎnjī chī diào le!", vn: "Thẻ rút tiền của tôi bị máy ATM nuốt mất rồi!" }
    ],
    idiom: "去領錢 (Qù lǐng qián) - Đi rút tiền.<br>🔸 Ví dụ: 我身上沒現金了，先去超商領錢。(Wǒ shēnshàng méi xiànjīn le, xiān qù chāoshāng lǐng qián. - Trên người tôi hết tiền mặt rồi, tôi ra siêu thị rút tiền trước đã.)", 
    level: "TOCFL A2"
  },
  {
    word: "超商", pinyin: "chāoshāng", hanViet: "Siêu thương",
    image: "",
    radical: "超 (Bộ Tẩu 走 - Chạy) + 商 (Bộ Khẩu 口 - Miệng)<br>💡 Mẹo nhớ: Cửa hàng (商) mà bạn có thể nhanh chóng chạy (走 - 超) ra mua đồ bất cứ lúc nào (24/7).",
    explanation: "Danh từ: Cửa hàng tiện lợi (Viết tắt của 超級商店).",
    compounds: [
      { tc: "超市", py: "chāoshì", vn: "siêu thị lớn" }
    ],
    examples: [
      { tc: "台灣的超商非常方便。", py: "Táiwān de chāoshāng fēicháng fāngbiàn.", vn: "Cửa hàng tiện lợi ở Đài Loan vô cùng tiện lợi." },
      { tc: "我要去超商買一杯咖啡。", py: "Wǒ yào qù chāoshāng mǎi yì bēi kāfēi.", vn: "Tôi muốn đi cửa hàng tiện lợi mua một ly cà phê." }
    ],
    idiom: "去超商取貨 (Qù chāoshāng qǔ huò) - Ra cửa hàng lấy hàng (Văn hóa mua sắm online rất phổ biến ở Đài Loan).<br>🔸 Ví dụ: 幫我拿一下，我要去超商取貨。(Bāng wǒ ná yíxià, wǒ yào qù chāoshāng qǔ huò. - Cầm giúp tôi một lát, tôi phải ra cửa hàng lấy đồ giao tới.)", 
    level: "TOCFL A2"
  },
  {
    word: "應該", pinyin: "yīnggāi", hanViet: "Ưng cai",
    image: "",
    radical: "應 (Bộ Tâm 心 - Trái tim) + 該 (Bộ Ngôn 言 - Lời nói)<br>💡 Mẹo nhớ: Chữ 應 có bộ Tâm (心) mang nghĩa là phản hồi từ trong tim. Lời nói (言 - 該) phát ra từ tâm thức để khuyên nhủ ai đó 'nên' làm gì.",
    explanation: "Động từ năng nguyện: Nên, phải, chắc là.",
    compounds: [
      { tc: "不應該", py: "bù yīnggāi", vn: "không nên" }
    ],
    examples: [
      { tc: "天氣變冷了，你應該多穿一點衣服。", py: "Tiānqì biàn lěng le, nǐ yīnggāi duō chuān yìdiǎn yīfú.", vn: "Trời trở lạnh rồi, bạn nên mặc thêm áo." },
      { tc: "他現在應該在圖書館看書。", py: "Tā xiànzài yīnggāi zài túshūguǎn kàn shū.", vn: "Bây giờ chắc là anh ấy đang đọc sách ở thư viện." }
    ],
    idiom: "這是應該的 (Zhè shì yīnggāi de) - Đây là việc nên làm mà (Dùng để đáp lại lời cảm ơn một cách khiêm tốn).<br>🔸 Ví dụ: A: 謝謝你的幫忙。 B: 別客氣，這是應該的！(A: Xièxiè nǐ de bāngmáng. B: Bié kèqì, zhè shì yīnggāi de! - A: Cảm ơn sự giúp đỡ của bạn. B: Đừng khách sáo, đây là việc nên làm mà!)", 
    level: "TOCFL A2"
  },
  {
    word: "郵局", pinyin: "yóujú", hanViet: "Bưu cục",
    image: "",
    radical: "郵 (Bộ Ấp 邑 - Vùng đất) + 局 (Bộ Thi 尸 - Thi thể/Mái hiên)<br>💡 Mẹo nhớ: Bộ Ấp (阝) thường chỉ một địa điểm, khu vực hành chính. 郵局 là một cơ quan hành chính lo việc chuyển phát thư từ.",
    explanation: "Danh từ: Bưu điện.",
    compounds: [
      { tc: "郵票", py: "yóupiào", vn: "tem thư" },
      { tc: "郵差", py: "yóuchāi", vn: "người đưa thư" }
    ],
    examples: [
      { tc: "請問最近的郵局在哪裡？", py: "Qǐngwèn zuìjìn de yóujú zài nǎlǐ?", vn: "Xin hỏi bưu điện gần nhất ở đâu?" },
      { tc: "我要去郵局寄一個包裹給媽媽。", py: "Wǒ yào qù yóujú jì yí ge bāoguǒ gěi māma.", vn: "Tôi muốn ra bưu điện gửi một bưu kiện cho mẹ." }
    ],
    idiom: "跑一趟郵局 (Pǎo yí tàng yóujú) - Chạy ra bưu điện một chuyến.<br>🔸 Ví dụ: 我下午得跑一趟郵局辦事。(Wǒ xiàwǔ děi pǎo yí tàng yóujú bànshì. - Chiều nay tôi phải chạy ra bưu điện một chuyến để lo việc.)", 
    level: "TOCFL A2"
  },
  {
    word: "提", pinyin: "tí", hanViet: "Đề",
    image: "",
    radical: "提 (Bộ Thủ 手 - Bàn tay)<br>💡 Mẹo nhớ: Dùng tay (手) để nhấc một vật (是 - thị) lên cao.",
    explanation: "Động từ: Xách, nhấc lên, nhắc đến, rút (tiền).",
    compounds: [
      { tc: "提早", py: "tízǎo", vn: "sớm hơn dự định" },
      { tc: "提醒", py: "tíxǐng", vn: "nhắc nhở" }
    ],
    examples: [
      { tc: "他手裡提著兩個大塑膠袋。", py: "Tā shǒu lǐ tízhe liǎng ge dà sùjiāodài.", vn: "Trong tay anh ấy đang xách hai cái túi nilon lớn." },
      { tc: "別再提那件不開心的事了。", py: "Bié zài tí nà jiàn bù kāixīn de shì le.", vn: "Đừng nhắc lại chuyện không vui đó nữa." }
    ],
    idiom: "提早下班 (Tízǎo xiàbān) - Tan làm sớm.<br>🔸 Ví dụ: 今天颱風來了，老闆讓我們提早下班。(Jīntiān táifēng lái le, lǎobǎn ràng wǒmen tízǎo xiàbān. - Hôm nay bão tới, sếp cho chúng tôi tan làm sớm.)", 
    level: "TOCFL A2"
  },
  {
    word: "那邊", pinyin: "nàbiān", hanViet: "Na biên",
    image: "",
    radical: "那 (Bộ Ấp 邑) + 邊 (Bộ Xước 辶 - Bước đi)<br>💡 Mẹo nhớ: Chữ 邊 (Biên) chỉ phương hướng, lề, rìa. 那邊 chỉ một vị trí nằm ở phía đằng kia, xa người nói.",
    ...
    examples: [
      { tc: "你看，那邊有一隻可愛的小貓。", py: "Nǐ kàn, nàbiān yǒu yì zhī kě'ài de xiǎomāo.", vn: "Bạn nhìn xem, bên kia có một chú mèo nhỏ dễ thương." },
      { tc: "洗手間在那邊，請跟我來。", py: "Xǐshǒujiān zài nàbiān, qǐng gēn wǒ lái.", vn: "Nhà vệ sinh ở bên kia, vui lòng đi theo tôi." }
    ],
    idiom: "就在那邊 (Jiù zài nàbiān) - Ngay bên kia kìa!<br>🔸 Ví dụ: 捷運站很近，就在那邊而已！(Jiéyùn zhàn hěn jìn, jiù zài nàbiān éryǐ! - Trạm tàu điện ngầm rất gần, ngay bên kia thôi!)", 
    level: "TOCFL A2"
  },
  {
    word: "師大", pinyin: "Shīdà", hanViet: "Sư đại",
    image: "",
    radical: "師 (Bộ Cân 巾 - Khăn) + 大 (Bộ Đại 大 - To lớn)<br>💡 Mẹo nhớ: 師 (Sư) nghĩa là người thầy, Đại (大) trong Đại học. Đây là ngôi trường danh tiếng chuyên đào tạo giáo viên và dạy tiếng Trung.",
    explanation: "Danh từ riêng: Viết tắt của 師範大學 (Đại học Sư phạm).",
    compounds: [
      { tc: "台大", py: "Táidà", vn: "Đại học Đài Loan" }
    ],
    examples: [
      { tc: "很多外國學生在師大學中文。", py: "Hěn duō wàiguó xuéshēng zài Shīdà xué Zhōngwén.", vn: "Rất nhiều sinh viên nước ngoài học tiếng Trung ở trường Sư Đại." },
      { tc: "從這裡去師大只要十分鐘。", py: "Cóng zhèlǐ qù Shīdà zhǐyào shí fēnzhōng.", vn: "Từ đây đến Sư Đại chỉ mất 10 phút." }
    ],
    idiom: "師大夜市 (Shīdà yèshì) - Chợ đêm Sư Đại.<br>🔸 Ví dụ: 晚上我們一起去師大夜市吃小吃吧！(Wǎnshàng wǒmen yìqǐ qù Shīdà yèshì chī xiǎochī ba! - Tối nay chúng ta cùng đi chợ đêm Sư Đại ăn vặt nhé!)", 
    level: "TOCFL A2"
  },
  {
    word: "和平東路", pinyin: "Hépíng Dōng Lù", hanViet: "Hòa Bình Đông Lộ",
    image: "",
    radical: "和 (Bộ Khẩu 口), 平 (Bộ Can 干), 東 (Bộ Mộc 木), 路 (Bộ Túc 足)<br>💡 Mẹo nhớ: 和 (Hòa) + 平 (Bình) = Hòa bình. 東 (Đông) = phía Đông. 路 = Đường.",
    explanation: "Danh từ riêng: Đường Hòa Bình Đông (Một con đường huyết mạch tại Đài Bắc).",
    compounds: [
      { tc: "馬路", py: "mǎlù", vn: "đường lớn" }
    ],
    examples: [
      { tc: "我家就住在和平東路上。", py: "Wǒ jiā jiù zhù zài Hépíng Dōng Lù shàng.", vn: "Nhà tôi nằm ngay trên đường Hòa Bình Đông." },
      { tc: "這路公車會經過和平東路。", py: "Zhè lù gōngchē huì jīngguò Hépíng Dōng Lù.", vn: "Tuyến xe buýt này sẽ đi ngang qua đường Hòa Bình Đông." }
    ],
    idiom: "走和平東路 (Zǒu Hépíng Dōng Lù) - Đi tuyến đường Hòa Bình Đông.<br>🔸 Ví dụ: 司機，請走和平東路，那邊比較不塞車。(Sījī, qǐng zǒu Hépíng Dōng Lù, nàbiān bǐjiào bù sāichē. - Bác tài, vui lòng đi đường Hòa Bình Đông, bên đó đỡ tắc xe hơn.)", 
    level: "TOCFL A2"
  },
  {
    word: "往前", pinyin: "wǎng qián", hanViet: "Vãng tiền",
    image: "",
    radical: "往 (Bộ Xích 彳 - Bước đi ngắn) + 前 (Bộ Đao 刀 - Con dao)<br>💡 Mẹo nhớ: Bộ Xích (彳) chỉ sự di chuyển. 往前 nghĩa là di chuyển nhắm thẳng về phía trước.",
    explanation: "Cụm từ: Hướng về phía trước.",
    compounds: [
      { tc: "往後", py: "wǎng hòu", vn: "về phía sau" },
      { tc: "往左", py: "wǎng zuǒ", vn: "về bên trái" }
    ],
    examples: [
      { tc: "一直往前走，你就會看到醫院。", py: "Yìzhí wǎng qián zǒu, nǐ jiù huì kàndào yīyuàn.", vn: "Cứ đi thẳng về phía trước, bạn sẽ nhìn thấy bệnh viện." },
      { tc: "車子請往前開一點。", py: "Chēzi qǐng wǎng qián kāi yìdiǎn.", vn: "Xe vui lòng lái lên phía trước một chút." }
    ],
    idiom: "一直往前走 (Yìzhí wǎng qián zǒu) - Cứ đi thẳng mãi.<br>🔸 Ví dụ: 出捷運站後，一直往前走五分鐘就到了。(Chū jiéyùn zhàn hòu, yìzhí wǎng qián zǒu wǔ fēnzhōng jiù dào le. - Sau khi ra khỏi trạm tàu điện ngầm, cứ đi thẳng 5 phút là tới.)", 
    level: "TOCFL A2"
  },
  {
    word: "右轉", pinyin: "yòu zhuǎn", hanViet: "Hữu chuyển",
    image: "",
    radical: "右 (Bộ Khẩu 口 - Cái miệng) + 轉 (Bộ Xa 車 - Xe cộ)<br>💡 Mẹo nhớ: Chữ 右 (Phải) tay phải đưa thức ăn vào miệng (口). Chữ 轉 (Chuyển) có bộ Xa (xe) ám chỉ bánh xe chuyển động đổi hướng.",
    explanation: "Động từ: Rẽ phải.",
    compounds: [
      { tc: "左轉", py: "zuǒ zhuǎn", vn: "rẽ trái" },
      { tc: "轉彎", py: "zhuǎnwān", vn: "chuyển hướng, rẽ" }
    ],
    examples: [
      { tc: "到下一個路口請右轉。", py: "Dào xià yí ge lùkǒu qǐng yòu zhuǎn.", vn: "Đến ngã rẽ tiếp theo xin vui lòng rẽ phải." },
      { tc: "看到紅綠燈右轉，學校就在右邊。", py: "Kàndào hónglùdēng yòu zhuǎn, xuéxiào jiù zài yòubiān.", vn: "Thấy đèn giao thông thì rẽ phải, trường học nằm ở bên phải." }
    ],
    idiom: "下個路口右轉 (Xià ge lùkǒu yòu zhuǎn) - Ngã tư tiếp theo rẽ phải (Khẩu lệnh Google Maps rất quen thuộc).<br>🔸 Ví dụ: 導航說，我們要在下個路口右轉。(Dǎoháng shuō, wǒmen yào zài xià ge lùkǒu yòu zhuǎn. - Bản đồ báo rằng chúng ta phải rẽ phải ở ngã tư tiếp theo.)", 
    level: "TOCFL A2"
  },
  {
    word: "聽起來", pinyin: "tīng qǐlái", hanViet: "Thính khởi lai",
    image: "",
    radical: "聽 (Bộ Nhĩ 耳 - Lỗ tai) + 起 (Bộ Tẩu 走 - Đi) + 來 (Bộ Nhân 人 - Người)<br>💡 Mẹo nhớ: Dùng tai (耳) để lắng nghe (聽). Cụm từ này dùng để đưa ra nhận xét, đánh giá sau khi tiếp nhận thông tin bằng tai.",
    explanation: "Cụm động từ: Nghe có vẻ, nghe nói.",
    compounds: [
      { tc: "看起來", py: "kàn qǐlái", vn: "nhìn có vẻ" },
      { tc: "吃起來", py: "chī qǐlái", vn: "ăn có vị như" }
    ],
    examples: [
      { tc: "這個計畫聽起來很不錯。", py: "Zhège jìhuà tīng qǐlái hěn búcuò.", vn: "Kế hoạch này nghe có vẻ rất tuyệt." },
      { tc: "他的聲音聽起來好像感冒了。", py: "Tā de shēngyīn tīng qǐlái hǎoxiàng gǎnmào le.", vn: "Giọng của anh ấy nghe có vẻ như bị cảm rồi." }
    ],
  ...
  },
{
  ...
  },
 {
  ...
  {
    word: "相當", pinyin: "xiāngdāng", hanViet: "Tương đương",
    image: "",
    radical: "相 (Bộ Mục 目) + 當 (Bộ Điền 田)<br>💡 Mẹo nhớ: Sự vật, sự việc tương đương, ngang bằng (相) nhau. Dùng như phó từ chỉ mức độ 'khá, tương đối'.",
    explanation: "Phó từ: Khá, tương đối.",
    compounds: [
      { tc: "相當好", py: "xiāngdāng hǎo", vn: "khá tốt" }
    ],
    examples: [
      { tc: "這家餐廳的菜相當好吃。", py: "Zhè jiā cāntīng de cài xiāngdāng hǎochī.", vn: "Đồ ăn của nhà hàng này khá là ngon." },
      { tc: "這個問題相當複雜。", py: "Zhège wèntí xiāngdāng fùzá.", vn: "Vấn đề này tương đối phức tạp." },
      { tc: "他今天的表現相當不錯。", py: "Tā jīntiān de biǎoxiàn xiāngdāng búcuò.", vn: "Biểu hiện của anh ấy hôm nay khá là không tồi." }
    ],
    idiom: "相當滿意 Xiāngdāng mǎnyì - Khá hài lòng.<br>🔸 Ví dụ: 老闆對我的報告相當滿意。 Lǎobǎn duì wǒ de bàogào xiāngdāng mǎnyì. - Sếp khá hài lòng với bản báo cáo của tôi.", 
    level: "TOCFL A2"
  },
  {
    word: "自行車", pinyin: "zìxíngchē", hanViet: "Tự hành xa",
    image: "",
    radical: "自 (Tự) + 行 (Hành) + 車 (Xa)<br>💡 Mẹo nhớ: Chiếc xe (車) mà bản thân mình (自) phải đạp thì nó mới di chuyển (行). (Từ này phổ biến ở Trung Quốc đại lục, tương đương với 腳踏車 ở Đài Loan).",
    explanation: "Danh từ: Xe đạp.",
    compounds: [
      { tc: "騎自行車", py: "qí zìxíngchē", vn: "đạp xe đạp" },
      { tc: "租自行車", py: "zū zìxíngchē", vn: "thuê xe đạp" }
    ],
    examples: [
      { tc: "我買了一輛新的自行車。", py: "Wǒ mǎi le yí liàng xīn de zìxíngchē.", vn: "Tôi đã mua một chiếc xe đạp mới." },
      { tc: "他每天騎自行車去上班。", py: "Tā měitiān qí zìxíngchē qù shàngbān.", vn: "Mỗi ngày anh ấy đều đạp xe đi làm." },
      { tc: "公園裡不能騎自行車。", py: "Gōngyuán lǐ bùnéng qí zìxíngchē.", vn: "Trong công viên không được đạp xe đạp." }
    ],
    idiom: "騎車兜風 Qí chē dōufēng - Đạp xe hóng gió.<br>🔸 Ví dụ: 週末我們去海邊騎車兜風吧。 Zhōumò wǒmen qù hǎibiān qí chē dōufēng ba. - Cuối tuần chúng ta ra bờ biển đạp xe hóng gió đi.", 
    level: "TOCFL A2"
  },
  {
    word: "床", pinyin: "chuáng", hanViet: "Sàng",
    image: "",
    radical: "床 (Bộ Nghiễm 广 + Bộ Mộc 木)<br>💡 Mẹo nhớ: Tấm gỗ (木) được đặt dưới mái hiên nhà (广) để nằm ngủ.",
    explanation: "Danh từ: Giường.",
    compounds: [
      { tc: "起床", py: "qǐchuáng", vn: "thức dậy" },
      { tc: "雙人床", py: "shuāngrénchuáng", vn: "giường đôi" }
    ],
    examples: [
      { tc: "這張床很大很舒服。", py: "Zhè zhāng chuáng hěn dà hěn shūfú.", vn: "Chiếc giường này rất to và thoải mái." },
      { tc: "我太累了，現在只想躺在床上。", py: "Wǒ tài lèi le, xiànzài zhǐ xiǎng tǎng zài chuáng shàng.", vn: "Tôi mệt quá rồi, bây giờ chỉ muốn nằm trên giường." },
      { tc: "他的房間裡只有一張床。", py: "Tā de fángjiān lǐ zhǐyǒu yì zhāng chuáng.", vn: "Trong phòng của anh ấy chỉ có một chiếc giường." }
    ],
    idiom: "賴床 Làichuáng - Ngủ nướng / Nằm ườn trên giường.<br>🔸 Ví dụ: 天氣太冷了，我每天早上都想賴床。 Tiānqì tài lěng le, wǒ měitiān zǎoshàng dōu xiǎng làichuáng. - Thời tiết lạnh quá, sáng nào tôi cũng muốn ngủ nướng.", 
    level: "TOCFL A2"
  },
  {
    word: "桌子", pinyin: "zhuōzi", hanViet: "Trác tử",
    image: "",
    radical: "桌 (Bộ Mộc 木) + 子 (Bộ Tử 子)<br>💡 Mẹo nhớ: Cái bàn thường được làm bằng gỗ (木).",
    explanation: "Danh từ: Bàn, cái bàn.",
    compounds: [
      { tc: "書桌", py: "shūzhuō", vn: "bàn học, bàn viết" },
      { tc: "餐桌", py: "cānzhuō", vn: "bàn ăn" }
    ],
    examples: [
      { tc: "桌子上有一本中文書。", py: "Zhuōzi shàng yǒu yì běn Zhōngwén shū.", vn: "Trên bàn có một quyển sách tiếng Trung." },
      { tc: "這張桌子太小了，放不下這麼多東西。", py: "Zhè zhāng zhuōzi tài xiǎo le, fàng bú xià zhème duō dōngxī.", vn: "Cái bàn này nhỏ quá, để không vừa nhiều đồ như vậy." },
      { tc: "請把你的杯子放在桌子上。", py: "Qǐng bǎ nǐ de bēizi fàng zài zhuōzi shàng.", vn: "Vui lòng đặt cốc của bạn lên trên bàn." }
    ],
    idiom: "同桌 Tóngzhuō - Bạn cùng bàn.<br>🔸 Ví dụ: 他是我小學時候的同桌。 Tā shì wǒ xiǎoxué shíhòu de tóngzhuō. - Cậu ấy là bạn cùng bàn thời tiểu học của tôi.", 
    level: "TOCFL A2"
  },
  {
    word: "椅子", pinyin: "yǐzi", hanViet: "Y tử",
    image: "",
    radical: "椅 (Bộ Mộc 木) + 子 (Bộ Tử 子)<br>💡 Mẹo nhớ: Chiếc ghế tựa thường được làm bằng gỗ (木) để ngồi.",
    explanation: "Danh từ: Ghế, cái ghế.",
    compounds: [
      { tc: "坐在椅子上", py: "zuò zài yǐzi shàng", vn: "ngồi trên ghế" }
    ],
    examples: [
      { tc: "房間裡有兩把椅子。", py: "Fángjiān lǐ yǒu liǎng bǎ yǐzi.", vn: "Trong phòng có hai cái ghế." },
      { tc: "請隨便找把椅子坐下。", py: "Qǐng suíbiàn zhǎo bǎ yǐzi zuò xià.", vn: "Xin cứ tùy ý tìm một cái ghế ngồi xuống." },
      { tc: "這把椅子壞了，不能坐。", py: "Zhè bǎ yǐzi huài le, bùnéng zuò.", vn: "Cái ghế này hỏng rồi, không ngồi được." }
    ],
    idiom: "辦公椅 Bàngōng yǐ - Ghế văn phòng.<br>🔸 Ví dụ: 為了保護腰，我買了一把很貴的辦公椅。 Wèile bǎohù yāo, wǒ mǎi le yì bǎ hěn guì de bàngōng yǐ. - Để bảo vệ eo, tôi đã mua một chiếc ghế văn phòng rất đắt.", 
    level: "TOCFL A2"
  },
  {
    word: "家具", pinyin: "jiājù", hanViet: "Gia cụ",
    image: "",
    radical: "家 (Bộ Miên 宀) + 具 (Bộ Bát 八)<br>💡 Mẹo nhớ: Những đồ dùng, công cụ (具) được trang bị ở trong nhà (家).",
    explanation: "Danh từ: Đồ nội thất.",
    compounds: [
      { tc: "買家具", py: "mǎi jiājù", vn: "mua đồ nội thất" },
      { tc: "新家具", py: "xīn jiājù", vn: "đồ nội thất mới" }
    ],
    examples: [
      { tc: "我們週末要去買一些新家具。", py: "Wǒmen zhōumò yào qù mǎi yìxiē xīn jiājù.", vn: "Cuối tuần chúng tôi phải đi mua một ít đồ nội thất mới." },
      { tc: "這套家具非常貴。", py: "Zhè tào jiājù fēicháng guì.", vn: "Bộ nội thất này vô cùng đắt." },
      { tc: "搬家時，家具怎麼辦？", py: "Bānjiā shí, jiājù zěnme bàn?", vn: "Lúc chuyển nhà, đồ nội thất phải làm sao?" }
    ],
    idiom: "家具店 Jiājù diàn - Cửa hàng nội thất.<br>🔸 Ví dụ: 前面有一家很大的家具店。 Qiánmiàn yǒu yì jiā hěn dà de jiājù diàn. - Phía trước có một cửa hàng nội thất rất lớn.", 
    level: "TOCFL A2"
  },
  {
    word: "而且", pinyin: "érqiě", hanViet: "Nhi thả",
    image: "",
    radical: "而 (Bộ Nhi 而) + 且 (Bộ Nhất 一)<br>💡 Mẹo nhớ: Liên từ dùng để nối hai mệnh đề, mang ý nghĩa bổ sung thêm.",
    explanation: "Liên từ: Hơn nữa, mà còn.",
    compounds: [
      { tc: "不但...而且...", py: "búdàn... érqiě...", vn: "không những... mà còn..." }
    ],
    examples: [
      { tc: "這個房間很大，而且很乾淨。", py: "Zhège fángjiān hěn dà, érqiě hěn gānjìng.", vn: "Căn phòng này rất lớn, hơn nữa còn rất sạch sẽ." },
      { tc: "他會說英文，而且說得很好。", py: "Tā huì shuō Yīngwén, érqiě shuō de hěn hǎo.", vn: "Anh ấy biết nói tiếng Anh, mà còn nói rất giỏi." },
      { tc: "這碗牛肉麵便宜而且好吃。", py: "Zhè wǎn niúròumiàn piányí érqiě hǎochī.", vn: "Tô mì bò này rẻ mà còn ngon nữa." }
    ],
    idiom: "而且還 Érqiě hái - Hơn nữa còn.<br>🔸 Ví dụ: 他很聰明，而且還很努力。 Tā hěn cōngmíng, érqiě hái hěn nǔlì. - Anh ấy rất thông minh, hơn nữa còn rất nỗ lực.", 
    level: "TOCFL A2"
  },
  {
    word: "吵", pinyin: "chǎo", hanViet: "Sảo",
    image: "",
    radical: "吵 (Bộ Khẩu 口)<br>💡 Mẹo nhớ: Dùng miệng (口) nói quá lớn, thiếu (少) ý tứ sẽ gây ra tiếng ồn ào.",
    explanation: "Tính từ / Động từ: Ồn ào, cãi nhau.",
    compounds: [
      { tc: "太吵了", py: "tài chǎo le", vn: "ồn quá" },
      { tc: "吵架", py: "chǎojià", vn: "cãi nhau" }
    ],
    examples: [
      { tc: "外面太吵了，我沒辦法看書。", py: "Wàimiàn tài chǎo le, wǒ méi bànfǎ kànshū.", vn: "Bên ngoài ồn ào quá, tôi không có cách nào đọc sách được." },
      { tc: "請不要在這裡大聲吵鬧。", py: "Qǐng búyào zài zhèlǐ dàshēng chǎonào.", vn: "Vui lòng đừng làm ồn lớn tiếng ở đây." },
      { tc: "他們兩個人又吵架了。", py: "Tāmen liǎng ge rén yòu chǎojià le.", vn: "Hai người bọn họ lại cãi nhau rồi." }
    ],
    idiom: "吵死人了 Chǎo sǐ rén le - Ồn chết đi được.<br>🔸 Ví dụ: 隔壁在裝修，每天都吵死人了。 Gébì zài zhuāngxiū, měitiān dōu chǎo sǐ rén le. - Hàng xóm đang sửa nhà, ngày nào cũng ồn chết đi được.", 
    level: "TOCFL A2"
  },
  {
    word: "生活費", pinyin: "shēnghuófèi", hanViet: "Sinh hoạt phí",
    image: "",
    radical: "生 (Sinh) + 活 (Thủy) + 費 (Bối 貝)<br>💡 Mẹo nhớ: Khoản tiền bạc, chi phí (費) dùng để duy trì cuộc sống (生活).",
    explanation: "Danh từ: Phí sinh hoạt, chi phí sinh hoạt.",
    compounds: [
      { tc: "賺生活費", py: "zhuàn shēnghuófèi", vn: "kiếm phí sinh hoạt" }
    ],
    examples: [
      { tc: "台北的生活費比較高。", py: "Táiběi de shēnghuófèi bǐjiào gāo.", vn: "Chi phí sinh hoạt ở Đài Bắc tương đối cao." },
      { tc: "我每個月的生活費是一萬塊。", py: "Wǒ měi ge yuè de shēnghuófèi shì yí wàn kuài.", vn: "Phí sinh hoạt mỗi tháng của tôi là mười nghìn tệ." },
      { tc: "打工可以幫我賺一點生活費。", py: "Dǎgōng kěyǐ bāng wǒ zhuàn yìdiǎn shēnghuófèi.", vn: "Đi làm thêm có thể giúp tôi kiếm được một ít phí sinh hoạt." }
    ],
    idiom: "付生活費 Fù shēnghuófèi - Trả phí sinh hoạt.<br>🔸 Ví dụ: 父母每個月都會給我付生活費。 Fùmǔ měi ge yuè dōu huì gěi wǒ fù shēnghuófèi. - Bố mẹ mỗi tháng đều sẽ chu cấp phí sinh hoạt cho tôi.", 
    level: "TOCFL A2"
  },
  {
    word: "低", pinyin: "dī", hanViet: "Đê",
    image: "",
    radical: "低 (Bộ Nhân 亻)<br>💡 Mẹo nhớ: Người (亻) cúi đầu xuống sát đất (底) biểu thị sự thấp bé, hạ thấp.",
    explanation: "Tính từ: Thấp.",
    compounds: [
      { tc: "薪水很低", py: "xīnshuǐ hěn dī", vn: "lương rất thấp" },
      { tc: "氣溫很低", py: "qìwēn hěn dī", vn: "nhiệt độ rất thấp" }
    ],
    examples: [
      { tc: "這個工作的薪水很低。", py: "Zhège gōngzuò de xīnshuǐ hěn dī.", vn: "Mức lương của công việc này rất thấp." },
      { tc: "今天晚上的氣溫很低，要多穿衣服。", py: "Jīntiān wǎnshàng de qìwēn hěn dī, yào duō chuān yīfú.", vn: "Nhiệt độ tối nay rất thấp, phải mặc nhiều áo vào." },
      { tc: "他的考試成績比我低。", py: "Tā de kǎoshì chéngjī bǐ wǒ dī.", vn: "Thành tích thi của anh ấy thấp hơn tôi." }
    ],
    idiom: "低頭 Dītóu - Cúi đầu.<br>🔸 Ví dụ: 請不要一直低頭看手機。 Qǐng búyào yìzhí dītóu kàn shǒujī. - Xin đừng lúc nào cũng cúi đầu xem điện thoại.", 
    level: "TOCFL A2"
  },
  {
    word: "留", pinyin: "liú", hanViet: "Lưu",
    image: "",
    radical: "留 (Bộ Điền 田)<br>💡 Mẹo nhớ: Giữ lại, cất giữ đồ đạc trên mảnh ruộng (田) của mình.",
    explanation: "Động từ: Lưu lại, ở lại, để lại.",
    compounds: [
      { tc: "留下來", py: "liú xiàlái", vn: "ở lại" },
      { tc: "留言", py: "liúyán", vn: "để lại lời nhắn" }
    ],
    examples: [
      { tc: "畢業後，他想留在台灣工作。", py: "Bìyè hòu, tā xiǎng liú zài Táiwān gōngzuò.", vn: "Sau khi tốt nghiệp, anh ấy muốn ở lại Đài Loan làm việc." },
      { tc: "請你在這裡留一下，主任馬上來。", py: "Qǐng nǐ zài zhèlǐ liú yíxià, zhǔrèn mǎshàng lái.", vn: "Xin bạn lưu lại đây một chút, chủ nhiệm tới ngay." },
      { tc: "我給他留了一張紙條。", py: "Wǒ gěi tā liú le yì zhāng zhǐtiáo.", vn: "Tôi đã để lại cho anh ấy một tờ giấy nhắn." }
    ],
    idiom: "留步 Liúbù - Dừng bước / Xin đừng tiễn.<br>🔸 Ví dụ: 外面下雨，請留步，我自己走就可以了。 Wàimiàn xiàyǔ, qǐng liúbù, wǒ zìjǐ zǒu jiù kěyǐ le. - Bên ngoài trời mưa, xin dừng bước, tôi tự đi là được rồi.", 
    level: "TOCFL A2"
  },
  {
    word: "長", pinyin: "cháng", hanViet: "Trường",
    image: "",
    radical: "長 (Bộ Trường 長)<br>💡 Mẹo nhớ: Chữ tượng hình mô phỏng người có mái tóc rất dài, mang ý nghĩa dài (trái nghĩa với ngắn).",
    explanation: "Tính từ: Dài.",
    compounds: [
      { tc: "很長", py: "hěn cháng", vn: "rất dài" }
    ],
    examples: [
      { tc: "這條路很長，我們還要走很久。", py: "Zhè tiáo lù hěn cháng, wǒmen hái yào zǒu hěn jiǔ.", vn: "Con đường này rất dài, chúng ta vẫn phải đi rất lâu." },
      { tc: "我們認識的時間不長。", py: "Wǒmen rènshí de shíjiān bù cháng.", vn: "Thời gian chúng tôi quen biết nhau không dài." },
      { tc: "你的頭髮變長了。", py: "Nǐ de tóufǎ biàn cháng le.", vn: "Tóc của bạn dài ra rồi kìa." }
    ],
    idiom: "長時間 Cháng shíjiān - Thời gian dài.<br>🔸 Ví dụ: 長時間看電腦對眼睛不好。 Cháng shíjiān kàn diànnǎo duì yǎnjīng bù hǎo. - Nhìn máy tính trong thời gian dài không tốt cho mắt.", 
    level: "TOCFL A2"
  },
  {
    word: "討論", pinyin: "tǎolùn", hanViet: "Thảo luận",
    image: "",
    radical: "討 (Bộ Ngôn 言) + 論 (Bộ Ngôn 言)<br>💡 Mẹo nhớ: Cả hai chữ đều có bộ Ngôn (lời nói), chỉ việc dùng lời nói để trao đổi, bàn bạc với nhau.",
    explanation: "Động từ: Thảo luận, bàn bạc.",
    compounds: [
      { tc: "討論問題", py: "tǎolùn wèntí", vn: "thảo luận vấn đề" }
    ],
    examples: [
      { tc: "我們正在討論明天的計畫。", py: "Wǒmen zhèngzài tǎolùn míngtiān de jìhuà.", vn: "Chúng tôi đang thảo luận về kế hoạch ngày mai." },
      { tc: "這個問題我們下次開會再討論。", py: "Zhège wèntí wǒmen xià cì kāihuì zài tǎolùn.", vn: "Vấn đề này chúng ta để lần họp sau hẵng bàn tiếp." },
      { tc: "大家討論得非常熱烈。", py: "Dàjiā tǎolùn de fēicháng rèliè.", vn: "Mọi người thảo luận vô cùng sôi nổi." }
    ],
    idiom: "討論報告 Tǎolùn bàogào - Thảo luận báo cáo.<br>🔸 Ví dụ: 下課後我們要留下來討論報告。 Xiàkè hòu wǒmen yào liú xiàlái tǎolùn bàogào. - Tan học xong chúng ta phải ở lại thảo luận báo cáo.", 
    level: "TOCFL A2"
  },
  {
    word: "社團", pinyin: "shètuán", hanViet: "Xã đoàn",
    image: "",
    radical: "社 (Bộ Thị 示) + 團 (Bộ Vi 囗)<br>💡 Mẹo nhớ: Một nhóm người tụ tập lại với nhau (團) để tạo thành một tổ chức, hội nhóm (社).",
    explanation: "Danh từ: Câu lạc bộ, hội nhóm.",
    compounds: [
      { tc: "參加社團", py: "cānjiā shètuán", vn: "tham gia câu lạc bộ" },
      { tc: "社團活動", py: "shètuán huódòng", vn: "hoạt động câu lạc bộ" }
    ],
    examples: [
      { tc: "你大學時參加了什麼社團？", py: "Nǐ dàxué shí cānjiā le shénme shètuán?", vn: "Hồi đại học bạn tham gia câu lạc bộ nào?" },
      { tc: "我們學校有很多有趣的社團。", py: "Wǒmen xuéxiào yǒu hěn duō yǒuqù de shètuán.", vn: "Trường chúng tôi có rất nhiều câu lạc bộ thú vị." },
      { tc: "今晚社團有一個歡迎新生的活動。", py: "Jīnwǎn shètuán yǒu yí ge huānyíng xīnshēng de huódòng.", vn: "Tối nay câu lạc bộ có một hoạt động chào đón tân sinh viên." }
    ],
    idiom: "社團博覽會 Shètuán bólǎnhuì - Hội chợ câu lạc bộ.<br>🔸 Ví dụ: 明天學校會舉辦社團博覽會。 Míngtiān xuéxiào huì jǔbàn shètuán bólǎnhuì. - Ngày mai trường sẽ tổ chức hội chợ câu lạc bộ.", 
    level: "TOCFL A2"
  },
  {
    word: "活動", pinyin: "huódòng", hanViet: "Hoạt động",
    image: "",
    radical: "活 (Bộ Thủy 氵) + 動 (Bộ Lực 力)<br>💡 Mẹo nhớ: Dùng sức lực (力) để vận động, tạo ra những sự kiện vui vẻ, tràn đầy sức sống (活).",
    explanation: "Danh từ: Hoạt động, sự kiện.",
    compounds: [
      { tc: "辦活動", py: "bàn huódòng", vn: "tổ chức hoạt động" }
    ],
    examples: [
      { tc: "週末你參加了什麼活動？", py: "Zhōumò nǐ cānjiā le shénme huódòng?", vn: "Cuối tuần bạn đã tham gia hoạt động gì?" },
      { tc: "這個活動非常有意思。", py: "Zhège huódòng fēicháng yǒuyìsī.", vn: "Sự kiện này vô cùng thú vị." },
      { tc: "學校常常舉辦各種文化活動。", py: "Xuéxiào chángcháng jǔbàn gè zhǒng wénhuà huódòng.", vn: "Trường học thường xuyên tổ chức các loại hoạt động văn hóa." }
    ],
    idiom: "戶外活動 Hùwài huódòng - Hoạt động ngoài trời.<br>🔸 Ví dụ: 我喜歡爬山、打球等戶外活動。 Wǒ xǐhuān páshān, dǎqiú děng hùwài huódòng. - Tôi thích leo núi, đánh bóng và các hoạt động ngoài trời khác.", 
    level: "TOCFL A2"
  },
  {
    word: "失望", pinyin: "shīwàng", hanViet: "Thất vọng",
    image: "",
    radical: "失 (Bộ Đại 大) + 望 (Bộ Nguyệt 月)<br>💡 Mẹo nhớ: Đánh mất (失) đi sự mong mỏi, hy vọng (望) ban đầu.",
    explanation: "Tính từ: Thất vọng.",
    compounds: [
      { tc: "很失望", py: "hěn shīwàng", vn: "rất thất vọng" },
      { tc: "令人失望", py: "lìngrén shīwàng", vn: "khiến người ta thất vọng" }
    ],
    examples: [
      { tc: "聽到這個壞消息，我真的很失望。", py: "Tīng dào zhège huài xiāoxī, wǒ zhēn de hěn shīwàng.", vn: "Nghe được tin xấu này, tôi thật sự rất thất vọng." },
      { tc: "他的表現讓老師很失望。", py: "Tā de biǎoxiàn ràng lǎoshī hěn shīwàng.", vn: "Sự thể hiện của anh ấy khiến giáo viên rất thất vọng." },
      { tc: "希望你不會對我失望。", py: "Xīwàng nǐ bú huì duì wǒ shīwàng.", vn: "Hy vọng bạn sẽ không thất vọng về tôi." }
    ],
    idiom: "不要失望 Búyào shīwàng - Đừng thất vọng.<br>🔸 Ví dụ: 雖然失敗了，但請不要失望，下次再努力。 Suīrán shībài le, dàn qǐng búyào shīwàng, xià cì zài nǔlì. - Tuy thất bại rồi, nhưng xin đừng thất vọng, lần sau nỗ lực thêm nhé.", 
    level: "TOCFL A2"
  },
  {
    word: "放心", pinyin: "fàngxīn", hanViet: "Phóng tâm",
    image: "",
    radical: "放 (Bộ Phộc 攵) + 心 (Bộ Tâm 心)<br>💡 Mẹo nhớ: Buông bỏ, đặt (放) những lo âu trong lòng (心) xuống để cảm thấy nhẹ nhõm.",
    explanation: "Tính từ ly hợp: Yên tâm.",
    compounds: [
      { tc: "不放心", py: "bù fàngxīn", vn: "không yên tâm" }
    ],
    examples: [
      { tc: "你放心，我會把這件事做好的。", py: "Nǐ fàngxīn, wǒ huì bǎ zhè jiàn shì zuò hǎo de.", vn: "Bạn yên tâm, tôi sẽ làm tốt việc này." },
      { tc: "看到他平安回來，媽媽才放心。", py: "Kàndào tā píng'ān huílái, māma cái fàngxīn.", vn: "Nhìn thấy anh ấy bình an trở về, mẹ mới yên tâm." },
      { tc: "出門在外，要好好照顧自己，讓父母放心。", py: "Chūmén zàiwài, yào hǎohǎo zhàogù zìjǐ, ràng fùmǔ fàngxīn.", vn: "Đi xa nhà, phải chăm sóc tốt bản thân để bố mẹ yên tâm." }
    ],
    idiom: "放心吧 Fàngxīn ba - Yên tâm đi.<br>🔸 Ví dụ: 放心吧，一切都會順利的。 Fàngxīn ba, yíqiè dōu huì shùnlì de. - Yên tâm đi, mọi thứ đều sẽ suôn sẻ thôi.", 
    level: "TOCFL A2"
  },
  {
    word: "用", pinyin: "yòng", hanViet: "Dụng",
    image: "",
    radical: "用 (Bộ Dụng 用)<br>💡 Mẹo nhớ: Chữ tượng hình giống như hình cái chuông, sau mượn âm làm từ 'sử dụng'.",
    explanation: "Động từ: Dùng, sử dụng.",
    compounds: [
      { tc: "不用", py: "búyòng", vn: "không cần dùng" },
      { tc: "有用", py: "yǒuyòng", vn: "có ích, hữu dụng" }
    ],
    examples: [
      { tc: "請問我可以用你的筆嗎？", py: "Qǐngwèn wǒ kěyǐ yòng nǐ de bǐ ma?", vn: "Xin hỏi tôi có thể dùng bút của bạn được không?" },
      { tc: "我爺爺不用智慧型手機。", py: "Wǒ yéye búyòng zhìhuìxíng shǒujī.", vn: "Ông nội tôi không dùng điện thoại thông minh." },
      { tc: "這個東西怎麼用？", py: "Zhège dōngxī zěnme yòng?", vn: "Cái đồ này dùng như thế nào?" }
    ],
    idiom: "好用 Hǎoyòng - Dễ dùng / Dùng tốt.<br>🔸 Ví dụ: 這個網站的字典很好用。 Zhège wǎngzhàn de zìdiǎn hěn hǎoyòng. - Từ điển của trang web này rất dễ dùng.", 
    level: "TOCFL A2"
  },
  {
    word: "首爾", pinyin: "Shǒu'ěr", hanViet: "Thủ Nhĩ",
    image: "",
    radical: "首 (Bộ Thủ 首) + 爾 (Bộ Hào 爻)<br>💡 Mẹo nhớ: Tên riêng phiên âm của thành phố Seoul.",
    explanation: "Danh từ riêng: Seoul (Thủ đô của Hàn Quốc).",
    compounds: [
      { tc: "去首爾", py: "qù Shǒu'ěr", vn: "đi Seoul" }
    ],
    examples: [
      { tc: "首爾是韓國的首都。", py: "Shǒu'ěr shì Hánguó de shǒudū.", vn: "Seoul là thủ đô của Hàn Quốc." },
      { tc: "我下個月要去首爾旅行。", py: "Wǒ xià ge yuè yào qù Shǒu'ěr lǚxíng.", vn: "Tháng sau tôi sẽ đi Seoul du lịch." },
      { tc: "首爾的冬天非常冷。", py: "Shǒu'ěr de dōngtiān fēicháng lěng.", vn: "Mùa đông ở Seoul vô cùng lạnh." }
    ],
  ...
  {
    word: "聊", pinyin: "liáo", hanViet: "Liêu",
    image: "",
    radical: "聊 (Bộ Nhĩ 耳)<br>💡 Mẹo nhớ: Dùng tai (耳) để lắng nghe và trò chuyện qua lại với nhau.",
    explanation: "Động từ: Nói chuyện, tán gẫu.",
    compounds: [
      { tc: "聊天", py: "liáotiān", vn: "nói chuyện phiếm" },
      { tc: "聊一聊", py: "liáo yì liáo", vn: "nói chuyện một chút" }
    ],
    examples: [
      { tc: "我們坐下來聊一聊吧。", py: "Wǒmen zuò xiàlái liáo yì liáo ba.", vn: "Chúng ta ngồi xuống nói chuyện một chút đi." },
      { tc: "你昨天跟他說了什麼？我們只聊了工作。", py: "Nǐ zuótiān gēn tā shuō le shénme? Wǒmen zhǐ liáo le gōngzuò.", vn: "Hôm qua bạn nói gì với anh ấy thế? Chúng tôi chỉ nói chuyện công việc thôi." },
      { tc: "我很喜歡跟她聊電影。", py: "Wǒ hěn xǐhuān gēn tā liáo diànyǐng.", vn: "Tôi rất thích nói chuyện về điện ảnh với cô ấy." }
    ],
    idiom: "聊得來 Liáodelái - Nói chuyện hợp nhau.<br>🔸 Ví dụ: 我們兩個人很聊得來。 Wǒmen liǎng ge rén hěn liáodelái. - Hai người chúng tôi nói chuyện rất hợp nhau.", 
    level: "TOCFL A2"
  },
  {
    word: "忽然", pinyin: "hūrán", hanViet: "Hốt nhiên",
    image: "",
    radical: "忽 (Bộ Tâm 心) + 然 (Bộ Hỏa 灬)<br>💡 Mẹo nhớ: Một ý nghĩ thoáng qua trong tâm (心) một cách bất ngờ, nhanh chóng.",
    explanation: "Phó từ: Đột nhiên, bỗng nhiên.",
    compounds: [
      { tc: "忽然發現", py: "hūrán fāxiàn", vn: "đột nhiên phát hiện" }
    ],
    examples: [
      { tc: "走在路上，天忽然下起雨來。", py: "Zǒu zài lùshàng, tiān hūrán xià qǐ yǔ lái.", vn: "Đang đi trên đường, trời bỗng nhiên đổ mưa." },
      { tc: "他忽然想起自己忘記帶錢包了。", py: "Tā hūrán xiǎngqǐ zìjǐ wàngjì dài qiánbāo le.", vn: "Anh ấy đột nhiên nhớ ra mình quên mang ví tiền rồi." },
      { tc: "我忽然有一個好主意。", py: "Wǒ hūrán yǒu yí ge hǎo zhǔyì.", vn: "Tôi bỗng nhiên có một ý kiến hay." }
    ],
    idiom: "忽然之間 Hūrán zhī jiān - Đột nhiên / Chỉ trong chớp mắt.<br>🔸 Ví dụ: 忽然之間，她就哭了起來。 Hūrán zhī jiān, tā jiù kū le qǐlái. - Đột nhiên, cô ấy liền bật khóc.", 
    level: "TOCFL A2"
  },
  {
    word: "聲音", pinyin: "shēngyīn", hanViet: "Thanh âm",
    image: "",
    radical: "聲 (Bộ Nhĩ 耳) + 音 (Bộ Âm 音)<br>💡 Mẹo nhớ: Dùng tai (耳) để tiếp nhận các loại âm thanh (音) truyền đến.",
    explanation: "Danh từ: Âm thanh, tiếng, giọng nói.",
    compounds: [
      { tc: "大聲", py: "dàshēng", vn: "lớn tiếng" },
      { tc: "小聲", py: "xiǎoshēng", vn: "nhỏ tiếng" }
    ],
    examples: [
      { tc: "你聽，這是什麼聲音？", py: "Nǐ tīng, zhè shì shénme shēngyīn?", vn: "Bạn nghe xem, đây là âm thanh gì vậy?" },
      { tc: "她的聲音很好聽。", py: "Tā de shēngyīn hěn hǎotīng.", vn: "Giọng nói của cô ấy rất hay." },
      { tc: "電視的聲音太大了，請關小一點。", py: "Diànshì de shēngyīn tài dà le, qǐng guān xiǎo yìdiǎn.", vn: "Tiếng tivi lớn quá, vui lòng vặn nhỏ lại một chút." }
    ],
    idiom: "大聲點 Dàshēng diǎn - Nói lớn tiếng lên chút.<br>🔸 Ví dụ: 這裡太吵了，請你說大聲點。 Zhèlǐ tài chǎo le, qǐng nǐ shuō dàshēng diǎn. - Ở đây ồn quá, xin bạn nói lớn tiếng lên một chút.", 
    level: "TOCFL A2"
  },
  {
    word: "奇怪", pinyin: "qíguài", hanViet: "Kỳ quái",
    image: "",
    radical: "奇 (Bộ Đại 大) + 怪 (Bộ Tâm 忄)<br>💡 Mẹo nhớ: Trong lòng (忄) cảm thấy mọi thứ to lớn (大) và khác thường.",
    explanation: "Tính từ: Kỳ lạ, kỳ quái.",
    compounds: [
      { tc: "很奇怪", py: "hěn qíguài", vn: "rất kỳ lạ" }
    ],
    examples: [
      { tc: "這件事情真奇怪。", py: "Zhè jiàn shìqíng zhēn qíguài.", vn: "Chuyện này thật kỳ lạ." },
      { tc: "那個人穿著奇怪的衣服。", py: "Nàge rén chuānzhe qíguài de yīfú.", vn: "Người đó đang mặc bộ quần áo kỳ lạ." },
      { tc: "我聽到了一個奇怪的聲音。", py: "Wǒ tīngdào le yí ge qíguài de shēngyīn.", vn: "Tôi đã nghe thấy một âm thanh kỳ lạ." }
    ],
    idiom: "少見多怪 Shǎojiàn duōguài - Ít thấy nên lấy làm lạ.<br>🔸 Ví dụ: 這在台灣很正常，你真是少見多怪。 Zhè zài Táiwān hěn zhèngcháng, nǐ zhēnshi shǎojiàn duōguài. - Chuyện này ở Đài Loan rất bình thường, bạn đúng là ít thấy nên lấy làm lạ.", 
    level: "TOCFL A2"
  },
  {
    word: "袋子", pinyin: "dàizi", hanViet: "Đại tử",
    image: "",
    radical: "袋 (Bộ Y 衣) + 子 (Bộ Tử 子)<br>💡 Mẹo nhớ: Chiếc túi được may từ vải vóc, quần áo (衣) để đựng đồ.",
    explanation: "Danh từ: Cái túi, bao, bị.",
    compounds: [
      { tc: "塑膠袋", py: "sùjiāodài", vn: "túi nilon" },
      { tc: "環保袋", py: "huánbǎodài", vn: "túi bảo vệ môi trường" }
    ],
    examples: [
      { tc: "請問你需要袋子嗎？", py: "Qǐngwèn nǐ xūyào dàizi ma?", vn: "Xin hỏi bạn có cần túi không?" },
      { tc: "他手裡提著兩個大袋子。", py: "Tā shǒu lǐ tízhe liǎng ge dà dàizi.", vn: "Trong tay anh ấy đang xách hai cái túi lớn." },
      { tc: "請把這些書裝進袋子裡。", py: "Qǐng bǎ zhèxiē shū zhuāng jìn dàizi lǐ.", vn: "Vui lòng cho những quyển sách này vào trong túi." }
    ],
    idiom: "購物袋 Gòuwùdài - Túi mua sắm.<br>🔸 Ví dụ: 去超市買東西記得帶購物袋。 Qù chāoshì mǎi dōngxī jìdé dài gòuwùdài. - Đi siêu thị mua đồ nhớ mang theo túi mua sắm.", 
    level: "TOCFL A2"
  },
  {
    word: "輛", pinyin: "liàng", hanViet: "Lượng",
    image: "",
    radical: "輛 (Bộ Xa 車)<br>💡 Mẹo nhớ: Chữ Lưỡng (兩 - hai) và bộ Xa (車 - xe). Lượng từ dùng cho các loại xe cộ có bánh xe.",
    explanation: "Lượng từ: Chiếc, cỗ (dùng cho xe cộ).",
    compounds: [
      { tc: "一輛車", py: "yí liàng chē", vn: "một chiếc xe" }
    ],
    examples: [
      { tc: "門口停著一輛白色的車。", py: "Ménkǒu tíngzhe yí liàng báisè de chē.", vn: "Trước cửa đang đỗ một chiếc xe màu trắng." },
      { tc: "那輛腳踏車是誰的？", py: "Nà liàng jiǎotàchē shì shuí de?", vn: "Chiếc xe đạp đó là của ai vậy?" },
      { tc: "我剛買了一輛新機車。", py: "Wǒ gāng mǎi le yí liàng xīn jīchē.", vn: "Tôi vừa mua một chiếc xe máy mới." }
    ],
    idiom: "這輛車 Zhè liàng chē - Chiếc xe này.<br>🔸 Ví dụ: 這輛車很貴，我買不起。 Zhè liàng chē hěn guì, wǒ mǎi bù qǐ. - Chiếc xe này rất đắt, tôi mua không nổi.", 
    level: "TOCFL A2"
  },
  {
    word: "一定", pinyin: "yídìng", hanViet: "Nhất định",
    image: "",
    radical: "一 (Bộ Nhất 一) + 定 (Bộ Miên 宀)<br>💡 Mẹo nhớ: Mọi việc đã được quyết định cố định, chắc chắn ở dưới một mái nhà (宀).",
    explanation: "Phó từ / Tính từ: Nhất định, chắc chắn / Nhất định (ở một mức độ nào đó).",
    compounds: [
      { tc: "不一定", py: "bù yídìng", vn: "không chắc, chưa chắc" }
    ],
    examples: [
      { tc: "我明天一定會來。", py: "Wǒ míngtiān yídìng huì lái.", vn: "Ngày mai tôi nhất định sẽ đến." },
      { tc: "他今天生病了，不一定會來上課。", py: "Tā jīntiān shēngbìng le, bù yídìng huì lái shàngkè.", vn: "Hôm nay anh ấy bị ốm rồi, chưa chắc sẽ đến lớp." },
      { tc: "學好中文需要一定的時間。", py: "Xué hǎo Zhōngwén xūyào yídìng de shíjiān.", vn: "Học tốt tiếng Trung cần một khoảng thời gian nhất định." }
    ],
    idiom: "說到做到，一定辦到 Shuō dào zuò dào, yídìng bàn dào - Nói được làm được, nhất định làm được.<br>🔸 Ví dụ: 你放心，我說到做到，一定辦到。 Nǐ fàngxīn, wǒ shuō dào zuò dào, yídìng bàn dào. - Bạn yên tâm, tôi nói được làm được, nhất định làm được.", 
    level: "TOCFL A2"
  },
  {
    word: "地點", pinyin: "dìdiǎn", hanViet: "Địa điểm",
    image: "",
    radical: "地 (Bộ Thổ 土) + 點 (Bộ Hỏa 灬)<br>💡 Mẹo nhớ: Một điểm (點) cụ thể nằm trên mặt đất (土 - 地).",
    explanation: "Danh từ: Địa điểm, vị trí.",
    compounds: [
      { tc: "開會地點", py: "kāihuì dìdiǎn", vn: "địa điểm họp" },
      { tc: "約會地點", py: "yuēhuì dìdiǎn", vn: "địa điểm hẹn hò" }
    ],
    examples: [
      { tc: "請問面試的地點在哪裡？", py: "Qǐngwèn miànshì de dìdiǎn zài nǎlǐ?", vn: "Xin hỏi địa điểm phỏng vấn ở đâu?" },
      { tc: "我們還沒決定聚餐的地點。", py: "Wǒmen hái méi juédìng jùcān de dìdiǎn.", vn: "Chúng tôi vẫn chưa quyết định địa điểm ăn liên hoan." },
      { tc: "這個地點離車站很近，非常方便。", py: "Zhège dìdiǎn lí chēzhàn hěn jìn, fēicháng fāngbiàn.", vn: "Địa điểm này cách bến xe rất gần, vô cùng tiện lợi." }
    ],
    idiom: "改變地點 Gǎibiàn dìdiǎn - Thay đổi địa điểm.<br>🔸 Ví dụ: 因為下雨，我們必須改變活動地點。 Yīnwèi xiàyǔ, wǒmen bìxū gǎibiàn huódòng dìdiǎn. - Vì trời mưa, chúng tôi bắt buộc phải thay đổi địa điểm hoạt động.", 
    level: "TOCFL A2"
  },
  {
    word: "為了", pinyin: "wèile", hanViet: "Vị liễu",
    image: "",
    radical: "為 (Bộ Hỏa 灬) + 了 (Bộ Quyết 亅)<br>💡 Mẹo nhớ: Cụm từ chuyên dùng để biểu thị mục đích của một hành động.",
    explanation: "Giới từ: Để, vì, nhằm (chỉ mục đích).",
    compounds: [
      { tc: "為了你好", py: "wèile nǐ hǎo", vn: "vì muốn tốt cho bạn" }
    ],
    examples: [
      { tc: "為了健康，他每天都去跑步。", py: "Wèile jiànkāng, tā měitiān dōu qù pǎobù.", vn: "Để có sức khỏe, mỗi ngày anh ấy đều đi chạy bộ." },
      { tc: "我這麼做都是為了你。", py: "Wǒ zhème zuò dōu shì wèile nǐ.", vn: "Tôi làm như vậy đều là vì bạn." },
      { tc: "為了學好中文，他決定去台灣留學。", py: "Wèile xué hǎo Zhōngwén, tā juédìng qù Táiwān liúxué.", vn: "Để học tốt tiếng Trung, anh ấy quyết định đi Đài Loan du học." }
    ],
    idiom: "為了賺錢 Wèile zhuànqián - Vì để kiếm tiền.<br>🔸 Ví dụ: 為了賺錢，他每天打兩份工。 Wèile zhuànqián, tā měitiān dǎ liǎng fèn gōng. - Vì để kiếm tiền, mỗi ngày anh ấy làm thêm hai công việc.", 
    level: "TOCFL A2"
  },
  {
    word: "保護", pinyin: "bǎohù", hanViet: "Bảo hộ",
    image: "",
    radical: "保 (Bộ Nhân 亻) + 護 (Bộ Ngôn 言)<br>💡 Mẹo nhớ: Con người (亻) dùng lời nói (言) và hành động để che chở, giữ gìn một thứ gì đó.",
    explanation: "Động từ: Bảo vệ, giữ gìn.",
    compounds: [
      { tc: "保護環境", py: "bǎohù huánjìng", vn: "bảo vệ môi trường" },
      { tc: "自我保護", py: "zìwǒ bǎohù", vn: "tự bảo vệ bản thân" }
    ],
    examples: [
      { tc: "我們應該好好保護環境。", py: "Wǒmen yīnggāi hǎohǎo bǎohù huánjìng.", vn: "Chúng ta nên bảo vệ môi trường cho thật tốt." },
      { tc: "父母總是想保護自己的孩子。", py: "Fùmǔ zǒngshì xiǎng bǎohù zìjǐ de háizi.", vn: "Cha mẹ lúc nào cũng muốn bảo vệ con cái của mình." },
      { tc: "戴太陽眼鏡可以保護眼睛。", py: "Dài tàiyáng yǎnjìng kěyǐ bǎohù yǎnjīng.", vn: "Đeo kính râm có thể bảo vệ đôi mắt." }
    ],
    idiom: "保護地球 Bǎohù dìqiú - Bảo vệ Trái Đất.<br>🔸 Ví dụ: 做資源回收也是保護地球的一種方式。 Zuò zīyuán huíshōu yě shì bǎohù dìqiú de yì zhǒng fāngshì. - Làm tái chế tài nguyên cũng là một cách để bảo vệ Trái Đất.", 
    level: "TOCFL A2"
  },
  {
    word: "分類", pinyin: "fēnlèi", hanViet: "Phân loại",
    image: "",
    radical: "分 (Bộ Đao 刀) + 類 (Bộ Hiệt 頁)<br>💡 Mẹo nhớ: Dùng dao (刀) để chia tách, cắt nhỏ ra thành từng loại (類) riêng biệt.",
    explanation: "Động từ / Danh từ: Phân loại.",
    compounds: [
      { tc: "垃圾分類", py: "lèsè fēnlèi", vn: "phân loại rác" },
      { tc: "分類清楚", py: "fēnlèi qīngchǔ", vn: "phân loại rõ ràng" }
    ],
    examples: [
      { tc: "在台灣，丟垃圾前必須先分類。", py: "Zài Táiwān, diū lèsè qián bìxū xiān fēnlèi.", vn: "Ở Đài Loan, trước khi vứt rác bắt buộc phải phân loại trước." },
      { tc: "這些書已經按照顏色分類好了。", py: "Zhèxiē shū yǐjīng ànzhào yánsè fēnlèi hǎo le.", vn: "Những quyển sách này đã được phân loại xong theo màu sắc rồi." },
      { tc: "請你幫我把這些資料分類一下。", py: "Qǐng nǐ bāng wǒ bǎ zhèxiē zīliào fēnlèi yíxià.", vn: "Xin bạn giúp tôi phân loại những tài liệu này một chút." }
    ],
    idiom: "做好分類 Zuò hǎo fēnlèi - Làm tốt việc phân loại.<br>🔸 Ví dụ: 為了環保，我們應該做好垃圾分類。 Wèile huánbǎo, wǒmen yīnggāi zuò hǎo lèsè fēnlèi. - Vì bảo vệ môi trường, chúng ta nên làm tốt việc phân loại rác.", 
    level: "TOCFL A2"
  },
  {
    word: "利用", pinyin: "lìyòng", hanViet: "Lợi dụng",
    image: "",
    radical: "利 (Bộ Đao 刂) + 用 (Bộ Dụng 用)<br>💡 Mẹo nhớ: Sử dụng (用) một thứ gì đó để mang lại lợi ích (利) cho bản thân.",
    explanation: "Động từ: Tận dụng, sử dụng, lợi dụng.",
    compounds: [
      { tc: "廢物利用", py: "fèiwù lìyòng", vn: "tận dụng đồ bỏ đi" },
      { tc: "利用時間", py: "lìyòng shíjiān", vn: "tận dụng thời gian" }
    ],
    examples: [
      { tc: "我們應該好好利用週末的時間讀書。", py: "Wǒmen yīnggāi hǎohǎo lìyòng zhōumò de shíjiān dúshū.", vn: "Chúng ta nên tận dụng tốt thời gian cuối tuần để đọc sách." },
      { tc: "他利用舊瓶子做了一個漂亮的花瓶。", py: "Tā lìyòng jiù píngzi zuò le yí ge piàoliang de huāpíng.", vn: "Anh ấy đã tận dụng cái chai cũ để làm một bình hoa đẹp." },
      { tc: "我不喜歡被人利用。", py: "Wǒ bù xǐhuān bèi rén lìyòng.", vn: "Tôi không thích bị người khác lợi dụng." }
    ],
    idiom: "好好利用 Hǎohǎo lìyòng - Tận dụng cho tốt.<br>🔸 Ví dụ: 這些資料很有用，你要好好利用。 Zhèxiē zīliào hěn yǒuyòng, nǐ yào hǎohǎo lìyòng. - Những tài liệu này rất hữu ích, bạn phải tận dụng cho tốt nhé.", 
    level: "TOCFL A2"
  },
  {
    word: "紙", pinyin: "zhǐ", hanViet: "Chỉ",
    image: "",
    radical: "紙 (Bộ Mịch 糸)<br>💡 Mẹo nhớ: Ngày xưa giấy thường được làm từ những sợi bông, tơ tằm (糸) ép mỏng.",
    explanation: "Danh từ: Giấy.",
    compounds: [
      { tc: "一張紙", py: "yì zhāng zhǐ", vn: "một tờ giấy" },
      { tc: "廢紙", py: "fèizhǐ", vn: "giấy lộn, giấy nháp" }
    ],
    examples: [
      { tc: "請問你可以給我一張紙嗎？", py: "Qǐngwèn nǐ kěyǐ gěi wǒ yì zhāng zhǐ ma?", vn: "Xin hỏi bạn có thể cho tôi một tờ giấy không?" },
      { tc: "這些紙都可以回收。", py: "Zhèxiē zhǐ dōu kěyǐ huíshōu.", vn: "Những loại giấy này đều có thể tái chế." },
      { tc: "請把名字寫在這張紙上。", py: "Qǐng bǎ míngzi xiě zài zhè zhāng zhǐ shàng.", vn: "Vui lòng viết tên lên trên tờ giấy này." }
    ],
    idiom: "白紙黑字 Báizhǐ hēizì - Giấy trắng mực đen (Bằng chứng rõ ràng).<br>🔸 Ví dụ: 合約上白紙黑字寫得很清楚。 Héyuē shàng báizhǐ hēizì xiě de hěn qīngchǔ. - Trên hợp đồng giấy trắng mực đen viết rất rõ ràng.", 
    level: "TOCFL A2"
  },
  {
    word: "瓶子", pinyin: "píngzi", hanViet: "Bình tử",
    image: "",
    radical: "瓶 (Bộ Ngõa 瓦) + 子 (Bộ Tử 子)<br>💡 Mẹo nhớ: Đồ vật dùng để đựng chất lỏng, thời xưa thường được nặn bằng đất nung, sành sứ (瓦).",
    explanation: "Danh từ: Cái chai, lọ, bình.",
    compounds: [
      { tc: "玻璃瓶", py: "bōlípíng", vn: "chai thủy tinh" },
      { tc: "水瓶", py: "shuǐpíng", vn: "bình nước" }
    ],
    examples: [
      { tc: "桌子上有一個空瓶子。", py: "Zhuōzi shàng yǒu yí ge kōng píngzi.", vn: "Trên bàn có một cái chai rỗng." },
      { tc: "請把這些塑膠瓶子拿去回收。", py: "Qǐng bǎ zhèxiē sùjiāo píngzi ná qù huíshōu.", vn: "Vui lòng mang những cái chai nhựa này đi tái chế." },
      { tc: "他不小心打破了一個玻璃瓶子。", py: "Tā bù xiǎoxīn dǎpò le yí ge bōlí píngzi.", vn: "Anh ấy vô tình làm vỡ một cái chai thủy tinh." }
    ],
    idiom: "寶特瓶 Bǎotèpíng - Chai nhựa PET (Từ rất phổ biến ở Đài Loan).<br>🔸 Ví dụ: 喝完飲料後，寶特瓶要丟進回收桶。 Hē wán yǐnliào hòu, bǎotèpíng yào diū jìn huíshōu tǒng. - Sau khi uống xong đồ uống, chai nhựa phải vứt vào thùng tái chế.", 
    level: "TOCFL A2"
  },
  {
    word: "塑膠", pinyin: "sùjiāo", hanViet: "Tố giao",
    image: "",
    radical: "塑 (Bộ Thổ 土) + 膠 (Bộ Nhục 肉)<br>💡 Mẹo nhớ: Vật liệu nhân tạo có tính chất dẻo, kết dính (膠) và có thể nặn thành hình (塑).",
    explanation: "Danh từ: Nhựa, plastic.",
    compounds: [
      { tc: "塑膠袋", py: "sùjiāodài", vn: "túi nilon" },
      { tc: "塑膠杯", py: "sùjiāo bēi", vn: "cốc nhựa" }
    ],
    examples: [
      { tc: "為了環保，我們應該少用塑膠袋。", py: "Wèile huánbǎo, wǒmen yīnggāi shǎo yòng sùjiāodài.", vn: "Vì bảo vệ môi trường, chúng ta nên ít sử dụng túi nilon." },
      { tc: "這張桌子是塑膠做的。", py: "Zhè zhāng zhuōzi shì sùjiāo zuò de.", vn: "Cái bàn này được làm bằng nhựa." },
      { tc: "塑膠垃圾對環境的影響很大。", py: "Sùjiāo lèsè duì huánjìng de yǐngxiǎng hěn dà.", vn: "Rác thải nhựa có ảnh hưởng rất lớn đến môi trường." }
    ],
    idiom: "減塑 Jiǎnsù - Giảm thiểu nhựa.<br>🔸 Ví dụ: 台灣現在推行減塑生活。 Táiwān xiànzài tuīxíng jiǎnsù shēnghuó. - Đài Loan hiện tại đang đẩy mạnh lối sống giảm thiểu nhựa.", 
    level: "TOCFL A2"
  },
  {
    word: "資源", pinyin: "zīyuán", hanViet: "Tư nguyên",
    image: "",
    radical: "資 (Bộ Bối 貝) + 源 (Bộ Thủy 氵)<br>💡 Mẹo nhớ: Nguồn gốc (源) mang lại giá trị như tiền bạc (貝 - 資) cho con người chính là tài nguyên.",
    explanation: "Danh từ: Tài nguyên.",
    compounds: [
      { tc: "資源回收", py: "zīyuán huíshōu", vn: "tái chế tài nguyên" },
      { tc: "天然資源", py: "tiānrán zīyuán", vn: "tài nguyên thiên nhiên" }
    ],
    examples: [
      { tc: "水是非常重要的資源。", py: "Shuǐ shì fēicháng zhòngyào de zīyuán.", vn: "Nước là một tài nguyên vô cùng quan trọng." },
      { tc: "我們應該好好保護地球的資源。", py: "Wǒmen yīnggāi hǎohǎo bǎohù dìqiú de zīyuán.", vn: "Chúng ta nên bảo vệ tốt tài nguyên của Trái Đất." },
      { tc: "星期三是我們社區的資源回收日。", py: "Xīngqísān shì wǒmen shèqū de zīyuán huíshōu rì.", vn: "Thứ Tư là ngày tái chế tài nguyên của khu phố chúng tôi." }
    ],
    idiom: "浪費資源 Làngfèi zīyuán - Lãng phí tài nguyên.<br>🔸 Ví dụ: 不關燈是一種浪費資源的行為。 Bù guān dēng shì yì zhǒng làngfèi zīyuán de xíngwéi. - Không tắt đèn là một hành vi lãng phí tài nguyên.", 
    level: "TOCFL A2"
  },
  {
    word: "回收桶", pinyin: "huíshōutǒng", hanViet: "Hồi thu thùng",
    image: "",
    radical: "回 (Bộ Vi 囗) + 收 (Bộ Phộc 攵) + 桶 (Bộ Mộc 木)<br>💡 Mẹo nhớ: Cái thùng bằng gỗ (木) dùng để thu gom đồ đạc tái chế.",
    explanation: "Danh từ: Thùng rác tái chế, thùng thu hồi.",
    compounds: [
      { tc: "資源回收桶", py: "zīyuán huíshōutǒng", vn: "thùng tái chế tài nguyên" }
    ],
    examples: [
      { tc: "請把空瓶子丟進回收桶裡。", py: "Qǐng bǎ kōng píngzi diū jìn huíshōutǒng lǐ.", vn: "Vui lòng vứt cái chai rỗng vào trong thùng tái chế." },
      { tc: "這個公園裡沒有回收桶。", py: "Zhège gōngyuán lǐ méiyǒu huíshōutǒng.", vn: "Trong công viên này không có thùng tái chế." },
      { tc: "垃圾桶旁邊那個藍色的是回收桶。", py: "Lèsè tǒng pángbiān nàge lánsè de shì huíshōutǒng.", vn: "Cái màu xanh lam bên cạnh thùng rác đó là thùng tái chế." }
    ],
    idiom: "分類回收桶 Fēnlèi huíshōutǒng - Thùng tái chế phân loại.<br>🔸 Ví dụ: 捷運站裡有很多分類回收桶。 Jiéyùn zhàn lǐ yǒu hěn duō fēnlèi huíshōutǒng. - Trong trạm tàu điện ngầm có rất nhiều thùng tái chế phân loại.", 
    level: "TOCFL A2"
  },
  {
    word: "城市", pinyin: "chéngshì", hanViet: "Thành thị",
    image: "",
    radical: "城 (Bộ Thổ 土) + 市 (Bộ Cân 巾)<br>💡 Mẹo nhớ: Nơi có tường thành (城) bao quanh và có chợ (市) buôn bán sầm uất.",
    explanation: "Danh từ: Thành phố, thành thị.",
    compounds: [
      { tc: "大城市", py: "dà chéngshì", vn: "thành phố lớn" },
      { tc: "城市生活", py: "chéngshì shēnghuó", vn: "cuộc sống thành thị" }
    ],
    examples: [
      { tc: "台北是一個很繁華的城市。", py: "Táiběi shì yí ge hěn fánhuá de chéngshì.", vn: "Đài Bắc là một thành phố rất phồn hoa." },
      { tc: "他習慣了城市的生活。", py: "Tā xíguàn le chéngshì de shēnghuó.", vn: "Anh ấy đã quen với cuộc sống thành phố rồi." },
      { tc: "這個城市的交通非常方便。", py: "Zhège chéngshì de jiāotōng fēicháng fāngbiàn.", vn: "Giao thông của thành phố này vô cùng tiện lợi." }
    ],
    idiom: "城市人 Chéngshì rén - Người thành phố.<br>🔸 Ví dụ: 很多城市人都喜歡去鄉下度假。 Hěn duō chéngshì rén dōu xǐhuān qù xiāngxià dùjià. - Rất nhiều người thành phố đều thích về quê nghỉ dưỡng.", 
    level: "TOCFL A2"
  },
  {
    word: "聽見", pinyin: "tīngjiàn", hanViet: "Thính kiến",
    image: "",
    radical: "聽 (Bộ Nhĩ 耳) + 見 (Bộ Kiến 見)<br>💡 Mẹo nhớ: Dùng tai (耳) để nghe (聽) và nhận thức được (見) âm thanh.",
    explanation: "Động từ: Nghe thấy, nghe được.",
    compounds: [
      { tc: "聽不見", py: "tīng bú jiàn", vn: "nghe không thấy" }
    ],
    examples: [
      { tc: "你聽見外面的聲音了嗎？", py: "Nǐ tīngjiàn wàimiàn de shēngyīn le ma?", vn: "Bạn có nghe thấy âm thanh bên ngoài không?" },
      { tc: "這裡太吵了，我聽不見你說話。", py: "Zhèlǐ tài chǎo le, wǒ tīng bú jiàn nǐ shuōhuà.", vn: "Ở đây ồn quá, tôi nghe không thấy bạn nói gì." },
      { tc: "我好像聽見有人在叫我的名字。", py: "Wǒ hǎoxiàng tīngjiàn yǒu rén zài jiào wǒ de míngzi.", vn: "Tôi hình như nghe thấy có người đang gọi tên mình." }
    ],
    idiom: "聽得見 Tīng de jiàn - Có thể nghe thấy.<br>🔸 Ví dụ: 你站在那裡聽得見嗎？ Nǐ zhàn zài nàlǐ tīng de jiàn ma? - Bạn đứng ở đó có nghe thấy không?", 
    level: "TOCFL A2"
  },
  {
    word: "開過來", pinyin: "kāi guòlái", hanViet: "Khai quá lai",
    image: "",
    radical: "開 (Bộ Môn 門) + 過 (Bộ Xước 辶) + 來 (Bộ Nhân 人)<br>💡 Mẹo nhớ: Hành động lái (開) xe băng qua (過) và hướng về phía người đang nói (來).",
    explanation: "Cụm động từ: Lái (xe) qua đây, chạy tới (hướng về phía người nói).",
    compounds: [
      { tc: "開過去", py: "kāi guòqù", vn: "lái qua đó" }
    ],
    examples: [
      { tc: "垃圾車開過來了，趕快去倒垃圾。", py: "Lèsè chē kāi guòlái le, gǎnkuài qù dào lèsè.", vn: "Xe rác lái tới rồi, mau đi đổ rác thôi." },
      { tc: "請你把車子開過來一點。", py: "Qǐng nǐ bǎ chēzi kāi guòlái yìdiǎn.", vn: "Xin bạn lái xe qua đây một chút." },
      { tc: "我看到他的車開過來了。", py: "Wǒ kàndào tā de chē kāi guòlái le.", vn: "Tôi nhìn thấy xe của anh ấy đang chạy tới rồi." }
    ],
    idiom: "把車開過來 Bǎ chē kāi guòlái - Lái xe qua đây.<br>🔸 Ví dụ: 你先在門口等，我把車開過來。 Nǐ xiān zài ménkǒu děng, wǒ bǎ chē kāi guòlái. - Bạn đứng đợi ở cửa trước đi, tôi lái xe qua đây.", 
    level: "TOCFL A2"
  },
  {
    word: "走過去", pinyin: "zǒu guòqù", hanViet: "Tẩu quá khứ",
    image: "",
    radical: "走 (Bộ Tẩu 走) + 過 (Bộ Xước 辶) + 去 (Bộ Tư 厶)<br>💡 Mẹo nhớ: Bước đi (走) băng qua (過) không gian theo hướng đi xa khỏi người nói (去).",
    explanation: "Cụm động từ: Đi qua đó, bước qua đó (hướng ra xa người nói).",
    compounds: [
      { tc: "走過來", py: "zǒu guòlái", vn: "đi qua đây" }
    ],
    examples: [
      { tc: "綠燈了，我們走過去吧。", py: "Lǜdēng le, wǒmen zǒu guòqù ba.", vn: "Đèn xanh rồi, chúng ta đi qua đó đi." },
      { tc: "他看見朋友，就高興地走過去了。", py: "Tā kànjiàn péngyǒu, jiù gāoxìng de zǒu guòqù le.", vn: "Anh ấy nhìn thấy bạn, liền vui vẻ bước qua đó." },
      { tc: "那家店不遠，我們走過去只要五分鐘。", py: "Nà jiā diàn bù yuǎn, wǒmen zǒu guòqù zhǐyào wǔ fēnzhōng.", vn: "Quán đó không xa, chúng ta đi bộ qua đó chỉ mất 5 phút." }
    ],
    idiom: "走過去看看 Zǒu guòqù kànkàn - Đi qua đó xem thử.<br>🔸 Ví dụ: 那邊好像發生了什麼事，我們走過去看看。 Nàbiān hǎoxiàng fāshēng le shénme shì, wǒmen zǒu guòqù kànkàn. - Bên kia hình như xảy ra chuyện gì đó, chúng ta đi qua đó xem thử đi.", 
    level: "TOCFL A2"
  },
  {
    word: "丟進去", pinyin: "diū jìnqù", hanViet: "Đâu tiến khứ",
    image: "",
    radical: "丟 (Bộ Nhất 一) + 進 (Bộ Xước 辶) + 去 (Bộ Tư 厶)<br>💡 Mẹo nhớ: Ném (丟) một đồ vật đi vào bên trong (進).",
    explanation: "Cụm động từ: Ném vào trong, vứt vào trong.",
    compounds: [
      { tc: "丟出來", py: "diū chūlái", vn: "ném ra ngoài" }
    ],
    examples: [
      { tc: "請把這些紙杯丟進去回收桶裡。", py: "Qǐng bǎ zhèxiē zhǐbēi diū jìnqù huíshōutǒng lǐ.", vn: "Vui lòng vứt những chiếc ly giấy này vào trong thùng tái chế." },
      { tc: "他把信丟進去郵筒了。", py: "Tā bǎ xìn diū jìnqù yóutǒng le.", vn: "Anh ấy đã vứt bức thư vào trong thùng thư rồi." },
      { tc: "不要把不好的東西丟進去洗衣機。", py: "Búyào bǎ bù hǎo de dōngxī diū jìnqù xǐyījī.", vn: "Đừng vứt những thứ không tốt vào trong máy giặt." }
    ],
    idiom: "把垃圾丟進去 Bǎ lèsè diū jìnqù - Vứt rác vào trong.<br>🔸 Ví dụ: 麻煩你把垃圾丟進去那個紅色的桶子裡。 Máfan nǐ bǎ lèsè diū jìnqù nàge hóngsè de tǒngzi lǐ. - Phiền bạn vứt rác vào trong cái thùng màu đỏ đó.", 
    level: "TOCFL A2"
  },
  {
    word: "路上", pinyin: "lùshàng", hanViet: "Lộ thượng",
    image: "",
    radical: "路 (Bộ Túc 足) + 上 (Bộ Nhất 一)<br>💡 Mẹo nhớ: Ở trên (上) mặt đường đi (路) hoặc đang trong quá trình di chuyển.",
    explanation: "Danh từ chỉ vị trí: Trên đường, trên đường đi.",
    compounds: [
      { tc: "馬路上", py: "mǎlù shàng", vn: "trên mặt đường" }
    ],
    examples: [
      { tc: "我現在在路上，馬上就到了。", py: "Wǒ xiànzài zài lùshàng, mǎshàng jiù dào le.", vn: "Tôi hiện đang trên đường, tới ngay đây." },
      { tc: "下雨天，路上的車子很多。", py: "Xiàyǔ tiān, lùshàng de chēzi hěn duō.", vn: "Ngày mưa, xe cộ trên đường rất đông." },
      { tc: "他在回家的路上買了晚餐。", py: "Tā zài huí jiā de lùshàng mǎi le wǎncān.", vn: "Anh ấy đã mua bữa tối ở trên đường về nhà." }
    ],
...
// =======================================================
// BÀI 2 - KHỐI 1: HỘI THOẠI & BÀI TẬP
// =======================================================
dialogueData.push({
    level: "TOCFL A2",
    lesson: "Bài 2",
    ...
    clozes: [
      { sentence: { zh: "我約了朋友一起去看 ______ 。", py: "Wǒ yuē le péngyǒu yìqǐ qù kàn ______ .", vn: "Tôi đã hẹn bạn cùng đi xem..." }, options: [ { zh: "展覽", vn: "triển lãm" }, { zh: "電影", vn: "phim ảnh" }, { zh: "捷運", vn: "tàu điện ngầm" } ], correct: 1 },
      { sentence: { zh: "朋友告訴我公車直接到展覽館，不必 ______ 。", py: "Péngyǒu gàosù wǒ gōngchē zhíjiē dào zhǎnlǎnguǎn, búbì ______ .", vn: "Bạn tôi nói xe buýt đi thẳng đến trung tâm triển lãm, không cần phải..." }, options: [ { zh: "換車", vn: "đổi xe" }, { zh: "走路", vn: "đi bộ" }, { zh: "買票", vn: "mua vé" } ], correct: 0 },
      { sentence: { zh: "聽起來坐捷運比較 ______ 。", py: "Tīng qǐlái zuò jiéyùn bǐjiào ______ .", vn: "Nghe có vẻ đi tàu điện ngầm tương đối..." }, options: [ { zh: "方便", vn: "thuận tiện" }, { zh: "舒服", vn: "thoải mái" }, { zh: "麻煩", vn: "phiền phức" } ], correct: 2 },
      { sentence: { zh: "一點也不麻煩，捷運比較快，坐公車要 ______ 一個多小時。", py: "Yìdiǎn yě bù máfán, jiéyùn bǐjiào kuài, zuò gōngchē yào ______ yí ge duō xiǎoshí.", vn: "Chút nào cũng không phiền, tàu điện ngầm nhanh hơn, đi xe buýt phải ... hơn một tiếng đồng hồ." }, options: [ { zh: "找", vn: "tìm" }, { zh: "花", vn: "tiêu tốn" }, { zh: "坐", vn: "ngồi" } ], correct: 1 },
      { sentence: { zh: "別急，走慢一點。捷運的 ______ 很多。", py: "Bié jí, zǒu màn yìdiǎn. Jiéyùn de ______ hěn duō.", vn: "Đừng vội, đi chậm một chút. ... tàu điện ngầm có rất nhiều." }, options: [ { zh: "班次", vn: "chuyến / lượt" }, { zh: "車站", vn: "nhà ga" }, { zh: "展覽", vn: "triển lãm" } ], correct: 0 }
    ],
    quizzes: [
      { question: { zh: "安同今天要去做什麼？", vn: "Antoine hôm nay muốn đi làm gì?" }, options: [ { zh: "去坐公車", vn: "Đi ngồi xe buýt" }, { zh: "去看電腦展", vn: "Đi xem triển lãm máy tính" }, { zh: "去看電影", vn: "Đi xem phim" } ], correct: 2 },
      { question: { zh: "如玉要去哪裡看電腦展？", vn: "Như Ngọc muốn đi đâu xem triển lãm máy tính?" }, options: [ { zh: "世貿展覽館", vn: "Trung tâm triển lãm Thương mại Thế giới" }, { zh: "台北車站", vn: "Ga Đài Bắc" }, { zh: "台北 101", vn: "Đài Bắc 101" } ], correct: 0 },
      { question: { zh: "為什麼如玉想坐公車去展覽館？", vn: "Tại sao Như Ngọc muốn đi xe buýt đến trung tâm triển lãm?" }, options: [ { zh: "因為捷運站很遠", vn: "Vì trạm tàu điện ngầm rất xa" }, { zh: "因為公車可以直接到，不必換車", vn: "Vì xe buýt có thể đến trực tiếp, không cần đổi xe" }, { zh: "因為公車比較快", vn: "Vì xe buýt nhanh hơn" } ], correct: 1 },
      { question: { zh: "安同覺得去展覽館坐什麼車比較好？", vn: "Antoine cảm thấy đi xe gì đến trung tâm triển lãm sẽ tốt hơn?" }, options: [ { zh: "計程車", vn: "Xe taxi" }, { zh: "捷運", vn: "Tàu điện ngầm" }, { zh: "公車", vn: "Xe buýt" } ], correct: 1 },
      { question: { zh: "安同為什麼叫如玉別急？", vn: "Tại sao Antoine bảo Như Ngọc đừng vội?" }, options: [ { zh: "因為展覽館很近", vn: "Vì trung tâm triển lãm rất gần" }, { zh: "因為捷運的班次很多", vn: "Vì tàu điện ngầm có rất nhiều chuyến" }, { zh: "因為時間還早", vn: "Vì thời gian vẫn còn sớm" } ], correct: 1 }
    ],
    reading: {
      paragraph: { 
        zh: "安同約了朋友去看電影，如玉要去世貿展覽館看電腦展。如玉本來想坐公車，因為可以直接到，不必換車。可是安同覺得公車太慢，要花一個多小時，他建議如玉坐捷運。雖然坐捷運得換車，可是比較快。最後，如玉聽了安同的建議，趕快去前面的捷運站搭車。", 
        py: "Āntóng yuē le péngyǒu qù kàn diànyǐng, Rúyù yào qù Shìmào zhǎnlǎnguǎn kàn diànnǎozhǎn. Rúyù běnlái xiǎng zuò gōngchē, yīnwèi kěyǐ zhíjiē dào, búbì huàn chē. Kěshì Āntóng juéde gōngchē tài màn, yào huā yí ge duō xiǎoshí, tā jiànyì Rúyù zuò jiéyùn. Suīrán zuò jiéyùn děi huàn chē, kěshì bǐjiào kuài. Zuìhòu, Rúyù tīng le Āntóng de jiànyì, gǎnkuài qù qiánmiàn de jiéyùnzhàn dā chē.", 
        vn: "Antoine đã hẹn bạn đi xem phim, Như Ngọc muốn đến Trung tâm triển lãm Thương mại Thế giới xem triển lãm máy tính. Như Ngọc vốn dĩ muốn đi xe buýt, bởi vì có thể đến trực tiếp, không cần đổi xe. Nhưng Antoine cảm thấy xe buýt quá chậm, phải mất hơn một tiếng đồng hồ, anh ấy đề nghị Như Ngọc đi tàu điện ngầm. Mặc dù đi tàu điện ngầm phải đổi xe, nhưng lại nhanh hơn. Cuối cùng, Như Ngọc nghe theo lời khuyên của Antoine, mau chóng đi đến trạm tàu điện ngầm ở phía trước để bắt xe." 
      },
      questions: [
        {
          question: { zh: "如玉要去哪裡？", vn: "Như Ngọc muốn đi đâu?" },
          options: [ { zh: "電影院", vn: "Rạp chiếu phim" }, { zh: "世貿展覽館", vn: "Trung tâm triển lãm Thương mại Thế giới" }, { zh: "台北車站", vn: "Ga Đài Bắc" } ], correct: 1
        },
        {
          question: { zh: "如玉為什麼想坐公車？", vn: "Tại sao Như Ngọc muốn đi xe buýt?" },
          options: [ { zh: "因為不必換車", vn: "Vì không cần đổi xe" }, { zh: "因為公車比較快", vn: "Vì xe buýt nhanh hơn" }, { zh: "因為公車比較便宜", vn: "Vì xe buýt rẻ hơn" } ], correct: 0
        },
        {
          question: { zh: "安同覺得坐什麼車比較快？", vn: "Antoine cảm thấy đi xe gì nhanh hơn?" },
          options: [ { zh: "計程車", vn: "Xe taxi" }, { zh: "公車", vn: "Xe buýt" }, { zh: "捷運", vn: "Tàu điện ngầm" } ], correct: 2
        }
      ]
    }
});
...
// =======================================================
// BÀI 2 - KHỐI 2: ĐOẠN VĂN ĐỌC HIỂU DÀI
// =======================================================
dialogueData.push({
    level: "TOCFL A2",
    lesson: "Bài 2",
    title: "Bài đọc: 美美來台灣玩 Mỹ Mỹ đến Đài Loan chơi",
    content: [
      { sp: "📖", gender: "female", zh: "如玉的朋友美美從法國到台灣來玩兩個禮拜，她先從歐洲坐飛機到越南，再轉機到台灣。到了機場，美美直接坐巴士到台北。如玉告訴她，在市區坐捷運是最方便的，所以她下了巴士，就坐捷運到旅館去了。", py: "Rúyù de péngyǒu Měiměi cóng Fàguó dào Táiwān lái wán liǎng ge lǐbài, tā xiān cóng Ōuzhōu zuò fēijī dào Yuènán, zài zhuǎnjī dào Táiwān. Dào le jīchǎng, Měiměi zhíjiē zuò bāshì dào Táiběi. Rúyù gàosù tā, zài shìqū zuò jiéyùn shì zuì fāngbiàn de, suǒyǐ tā xià le bāshì, jiù zuò jiéyùn dào lǚguǎn qù le.", vn: "Bạn của Như Ngọc là Mỹ Mỹ từ Pháp đến Đài Loan chơi hai tuần, cô ấy trước tiên từ Châu Âu đi máy bay đến Việt Nam, rồi chuyển bay đến Đài Loan. Tới sân bay, Mỹ Mỹ ngồi xe buýt trực tiếp đến Đài Bắc. Như Ngọc nói với cô ấy, ở khu vực thành phố đi tàu điện ngầm là tiện lợi nhất, cho nên sau khi xuống xe buýt, cô ấy liền đi tàu điện ngầm đến khách sạn." },
      { sp: "📖", gender: "female", zh: "美美覺得台北的交通非常便利，到處都有公車、計程車，還有捷運，去哪裡都很方便。台北捷運的路線不複雜，車票也不貴，買一張悠遊卡，誰都可以輕輕鬆鬆地去逛逛。", py: "Měiměi juéde Táiběi de jiāotōng fēicháng biànlì, dàochù dōu yǒu gōngchē, jìchéngchē, hái yǒu jiéyùn, qù nǎlǐ dōu hěn fāngbiàn. Táiběi jiéyùn de lùxiàn bù fùzá, chēpiào yě bú guì, mǎi yì zhāng yōuyóukǎ, shéi dōu kěyǐ qīngqīng-sōngsōng de qù guàngguang.", vn: "Mỹ Mỹ cảm thấy giao thông ở Đài Bắc vô cùng tiện lợi, khắp nơi đều có xe buýt, xe taxi, còn có tàu điện ngầm, đi đâu cũng đều rất tiện. Tuyến đường của tàu điện ngầm Đài Bắc không phức tạp, vé xe cũng không đắt, mua một tấm thẻ EasyCard (thẻ Du Du), ai cũng có thể nhẹ nhàng thoải mái đi dạo phố." },
      { sp: "📖", gender: "female", zh: "美美住在法國東部，沒有什麼機會到海邊。聽說台灣附近的小島，風景都很美，所以她決定到綠島去看看。綠島在台灣的東南邊，到那裡不太方便。美美得先坐火車到台東，再搭船或是飛機到綠島。她打算第二個星期去綠島，好好地玩一玩。", py: "Měiměi zhù zài Fàguó dōngbù, méiyǒu shénme jīhuì dào hǎibiān. Tīngshuō Táiwān fùjìn de xiǎodǎo, fēngjǐng dōu hěn měi, suǒyǐ tā juédìng dào Lǜdǎo qù kànkan. Lǜdǎo zài Táiwān de dōngnán biān, dào nàlǐ bú tài fāngbiàn. Měiměi děi xiān zuò huǒchē dào Táidōng, zài dā chuán huòshì fēijī dào Lǜdǎo. Tā dǎsuàn dì èr ge xīngqí qù Lǜdǎo, hǎohāo de wán yì wán.", vn: "Mỹ Mỹ sống ở miền Đông nước Pháp, không có cơ hội gì để đến bờ biển. Nghe nói những hòn đảo nhỏ gần Đài Loan, phong cảnh đều rất đẹp, cho nên cô ấy quyết định đến Lục Đảo xem thử. Lục Đảo nằm ở phía Đông Nam của Đài Loan, đến đó không được tiện cho lắm. Mỹ Mỹ phải ngồi xe lửa đến Đài Đông trước, rồi mới đi thuyền hoặc là máy bay đến Lục Đảo. Cô ấy dự định tuần thứ hai sẽ đi Lục Đảo, chơi đùa thật thỏa thích." }
    ],
    clozes: [],
    quizzes: [],
    reading: {
      ...
      questions: [
        { question: { zh: "美美從法國到台灣，是在哪裡轉機的？", vn: "Mỹ Mỹ từ Pháp đến Đài Loan, đã chuyển bay ở đâu?" }, options: [ { zh: "日本 (Nhật Bản)", vn: "Nhật Bản" }, { zh: "越南 (Việt Nam)", vn: "Việt Nam" }, { zh: "韓國 (Hàn Quốc)", vn: "Hàn Quốc" } ], correct: 1 },
        { question: { zh: "美美到了機場以後，怎麼去台北？", vn: "Sau khi Mỹ Mỹ đến sân bay, đã đi đến Đài Bắc bằng cách nào?" }, options: [ { zh: "坐巴士", vn: "Đi xe buýt" }, { zh: "坐捷運", vn: "Đi tàu điện ngầm" }, { zh: "坐計程車", vn: "Đi taxi" } ], correct: 0 },
        { question: { zh: "根據短文，台北捷運怎麼樣？", vn: "Theo đoạn văn ngắn, tàu điện ngầm Đài Bắc như thế nào?" }, options: [ { zh: "路線很複雜", vn: "Tuyến đường rất phức tạp" }, { zh: "車票很貴", vn: "Vé xe rất đắt" }, { zh: "很方便，買悠遊卡就可以坐", vn: "Rất tiện lợi, mua thẻ EasyCard là có thể đi" } ], correct: 2 },
        { question: { zh: "美美為什麼決定去綠島？", vn: "Tại sao Mỹ Mỹ quyết định đi Lục Đảo?" }, options: [ { zh: "因為她住的地方沒有海邊，而且聽說那裡的風景很美", vn: "Vì nơi cô ấy sống không có bờ biển, vả lại nghe nói phong cảnh ở đó rất đẹp" }, { zh: "因為綠島的交通很方便", vn: "Vì giao thông ở Lục Đảo rất tiện lợi" }, { zh: "因為她想去綠島坐火車", vn: "Vì cô ấy muốn đến Lục Đảo đi xe lửa" } ], correct: 0 },
        { question: { zh: "從台北到綠島，美美要怎麼去？", vn: "Từ Đài Bắc đến Lục Đảo, Mỹ Mỹ phải đi như thế nào?" }, options: [ { zh: "直接坐飛機去", vn: "Ngồi máy bay trực tiếp đi" }, { zh: "先坐火車到台東，再搭船或飛機", vn: "Đi xe lửa đến Đài Đông trước, rồi đi thuyền hoặc máy bay" }, { zh: "先坐公車，再換捷運", vn: "Đi xe buýt trước, rồi đổi sang tàu điện ngầm" } ], correct: 1 }
      ]
    }
});
dialogueData.push({
